        ...
        <div class="col-xl-8">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('permohonan-non-litigasi.store')); ?>" enctype="multipart/form-data" id="nonLitigasiForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nama_pemohon')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" rows="3" required><?php echo e(old('alamat_pemohon')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('telp_hp_pemohon')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nik_pemohon')); ?>" maxlength="16" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end pt-3 border-top gap-2">
                            <a href="<?php echo e(route('permohonan-non-litigasi.index')); ?>" class="btn btn-light border fw-medium">Batal</a>
...
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/permohonan/non_litigasi/create.blade.php ENDPATH**/ ?>