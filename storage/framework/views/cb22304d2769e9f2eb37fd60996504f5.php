...
<body>
    ...
    <div class="print-btn no-print">
        ...
        <a href="<?php echo e(route('permohonan-non-litigasi.show', $permohonanNonLitigasi)); ?>" class="btn btn-secondary fw-medium ms-2">← Kembali</a>
    </div>
    ...
    <div class="page">
        ...
        <table>
            <tbody>
                <tr><th>Nama Pemohon</th><td><?php echo e($permohonanNonLitigasi->nama_pemohon); ?></td></tr>
                <tr><th>NIK Pemohon</th><td><?php echo e($permohonanNonLitigasi->nik_pemohon); ?></td></tr>
                <tr><th>Alamat Pemohon</th><td><?php echo e($permohonanNonLitigasi->alamat_pemohon); ?></td></tr>
                <tr><th>Telp / HP</th><td><?php echo e($permohonanNonLitigasi->telp_hp_pemohon); ?></td></tr>
            </tbody>
        </table>
        ...
        <table>
            <tbody>
                <tr><th>Jenis Perkara</th><td><?php echo e($permohonanNonLitigasi->jenis_perkara); ?></td></tr>
                <tr><th>Tgl. Rencana Kunjungan</th><td><?php echo e($permohonanNonLitigasi->tgl_rencana_kunjungan->format('d M Y')); ?></td></tr>
                <tr>
        ...
        <?php else: ?>
            <p style="font-size: 11pt; color: #555;">[File PDF terlampir – <?php echo e(basename($permohonanNonLitigasi->file_ktp_kk)); ?>]</p>
        <?php endif; ?>
        <?php endif; ?>
        ...
        <?php else: ?>
            <p style="font-size: 11pt; color: #555;">[File PDF terlampir – <?php echo e(basename($permohonanNonLitigasi->file_sktm)); ?>]</p>
        <?php endif; ?>
        <?php endif; ?>
        ...
        <div style="margin-top: 48px; display: flex; justify-content: flex-end;">
            <div style="text-align: center; min-width: 240px;">
                ...
                <div style="font-size: 11pt; margin-top: 4px;"><?php echo e($permohonanNonLitigasi->created_at->format('d M Y')); ?></div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/permohonan/non_litigasi/print.blade.php ENDPATH**/ ?>