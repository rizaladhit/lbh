        ...
        <div class="col-md-10 col-lg-8">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4">
                        <form method="POST" action="<?php echo e(route('lawyers.update', $lawyer)); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                name="no_identitas" value="<?php echo e(old('no_identitas', $lawyer->no_identitas)); ?>" placeholder="Contoh: SIU/001/2024" required>
...
unset($__errorArgs, $__bag); ?>" name="user_id" required>
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" 
                                                ...
                                                <?php echo e(old('user_id', $lawyer->user_id) == $user->id ? 'selected' : ''); ?>>
                                            <?php echo e($user->email); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <input type="hidden" name="email" id="email" value="<?php echo e(old('email', $lawyer->email)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                    name="phone" value="<?php echo e(old('phone', $lawyer->phone)); ?>" placeholder="Contoh: 08xxxxxxxxxx" required>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="Hukum Pidana" <?php echo e(old('specialization', $lawyer->specialization) === 'Hukum Pidana' ? 'selected' : ''); ?>>Hukum Pidana</option>
                                <option value="Hukum Perdata" <?php echo e(old('specialization', $lawyer->specialization) === 'Hukum Perdata' ? 'selected' : ''); ?>>Hukum Perdata</option>
                                <option value="Hukum Keluarga" <?php echo e(old('specialization', $lawyer->specialization) === 'Hukum Keluarga' ? 'selected' : ''); ?>>Hukum Keluarga</option>
                                <option value="Hukum Kerja" <?php echo e(old('specialization', $lawyer->specialization) === 'Hukum Kerja' ? 'selected' : ''); ?>>Hukum Kerja</option>
                                <option value="Hukum Tata Negara" <?php echo e(old('specialization', $lawyer->specialization) === 'Hukum Tata Negara' ? 'selected' : ''); ?>>Hukum Tata Negara</option>
                                <option value="Hukum Administrasi" <?php echo e(old('specialization', $lawyer->specialization) === 'Hukum Administrasi' ? 'selected' : ''); ?>>Hukum Administrasi</option>
                                <option value="Lainnya" <?php echo e(old('specialization', $lawyer->specialization) === 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                name="address" rows="3" placeholder="Masukkan alamat kantor atau alamat pribadi"><?php echo e(old('address', $lawyer->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="active" <?php echo e(old('status', $lawyer->status) === 'active' ? 'selected' : ''); ?>>Aktif</option>
                                <option value="inactive" <?php echo e(old('status', $lawyer->status) === 'inactive' ? 'selected' : ''); ?>>Tidak Aktif</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                            <a href="<?php echo e(route('lawyers.show', $lawyer)); ?>" class="btn btn-light fw-medium">Batalkan</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/lawyers/edit.blade.php ENDPATH**/ ?>