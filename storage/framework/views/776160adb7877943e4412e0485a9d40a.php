...
unset($__errorArgs, $__bag); ?>"
                                name="no_kta_lbh" value="<?php echo e(old('no_kta_lbh', $lawyer->no_kta_lbh)); ?>" placeholder="Contoh: KTA/LBH/001/2024">
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__currentLoopData = $keahlians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keahlian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($keahlian->nama); ?>" <?php echo e(old('specialization', $lawyer->specialization) === $keahlian->nama ? 'selected' : ''); ?>>
