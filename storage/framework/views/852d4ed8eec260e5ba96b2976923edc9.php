...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Buat Laporan Penyuluhan Hukum <?php $__env->endSlot(); ?>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="<?php echo e(route('penyuluhan-hukum-reports.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="penerima_bantuan" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('penerima_bantuan')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="tempat_pelaksanaan" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('tempat_pelaksanaan')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="materi" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('materi')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="narasumber" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('narasumber')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="<?php echo e(route('penyuluhan-hukum-reports.index')); ?>" class="btn btn-light border me-2 fw-medium">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\penyuluhan_hukum_reports\create.blade.php ENDPATH**/ ?>