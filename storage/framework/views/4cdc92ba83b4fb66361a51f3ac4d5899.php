...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Laporan Pendampingan Diluar Pengadilan <?php $__env->endSlot(); ?>
    ...
    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 style="font-size:.85rem;font-weight:600;" class="mb-0 fw-bold text-body">Daftar Laporan Pendampingan Diluar Pengadilan</h6>
                    <div style="font-size:.72rem;color:#94a3b8;">Total <?php echo e($reports->total()); ?> laporan terdata</div>
                </div>
            </div>
            <a href="<?php echo e(route('pendampingan-reports.create')); ?>" class="btn-cta">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span style="font-size:.85rem;font-weight:600;" class="text-body">
                                    <?php echo e($report->tgl_pendampingan_1?->format('d M Y') ?? '-'); ?>
                        ...
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                <a href="<?php echo e(route('pendampingan-reports.show', $report)); ?>" class="action-btn" style="color:#6366f1;" title="Detail Laporan">
                                    <i class="fa-solid fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('pendampingan-reports.edit', $report)); ?>" class="action-btn" style="color:#f59e0b;" title="Edit Laporan">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <button onclick="confirmDelete('<?php echo e(route('pendampingan-reports.destroy', $report)); ?>')" class="action-btn" style="color:#ef4444;" title="Hapus Laporan">
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <h6 style="font-size:.85rem;font-weight:600;" class="fw-bold text-body mb-1">Belum Ada Laporan Pendampingan</h6>
                                <p class="text-muted mb-4" style="font-size:.85rem;">Mulai dengan membuat laporan Pendampingan Diluar Pengadilan yang pertama.</p>
                                <a href="<?php echo e(route('pendampingan-reports.create')); ?>" class="btn-cta" style="margin:auto;width:fit-content;">
    ...
    <script>
        function confirmDelete(action){
            if(!confirm('Hapus laporan Pendampingan ini secara permanen?')) return;
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/pendampingan_reports/index.blade.php ENDPATH**/ ?>