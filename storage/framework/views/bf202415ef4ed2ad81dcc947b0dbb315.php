...
<head>
    ...
    <title>Cetak Checklist Berkas - <?php echo e($pidanaReport->obh); ?></title>
...
<body>
    ...
    <div class="print-actions">
        ...
        <a href="<?php echo e(route('pidana-reports.show', $pidanaReport)); ?>" class="btn btn-secondary btn-sm fw-medium">
            Kembali
        </a>
    </div>
    ...
    <main class="page">
        ...
        <div class="pv-group pv-g1">
            <div class="pv-row">
                ...
                <span class="pv-val"><?php echo e($pidanaReport->obh); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">ALAMAT</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($pidanaReport->alamat); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">PROVINSI</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($pidanaReport->provinsi); ?></span>
            </div>
        </div>
        ...
        <div class="pv-group pv-g2">
            <div class="pv-row">
                ...
                <span class="pv-sep">:</span>
                <span class="pv-val-fixed">PIDANA</span>
            </div>
            <div class="pv-row">
                <span class="pv-label">KASUS</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($pidanaReport->kasus); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">NOMOR PERKARA</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($pidanaReport->nomor_perkara); ?></span>
            </div>
            <div class="pv-row">
        ...
        <div class="pv-keterangan page-2">
...
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\pidana_reports\print.blade.php ENDPATH**/ ?>