...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Laporan Penelitian Hukum <?php $__env->endSlot(); ?>
    ...
    <div class="panel">
        <div class="panel-head">
            ...
            <a href="<?php echo e(route('penelitian-hukum-reports.create')); ?>" class="btn-cta">
        ...
        <div class="table-responsive">
            <table class="data-table table">
                <thead>
                    <tr>
                        <th style="padding-left:24px;">Judul Penelitian</th>
                        <th>OBH & Kegiatan</th>
                        <th>Provinsi</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding-left:24px;">
                            <div style="font-size:.85rem;font-weight:600;" class="text-body"><?php echo e(Str::limit($report->judul_penelitian, 38)); ?></div>
                        </td>
                        <td>
                        ...
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                <a href="<?php echo e(route('penelitian-hukum-reports.show', $report)); ?>" class="action-btn" style="color:#6366f1;" title="Detail Laporan">
                                    <i class="fa-solid fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('penelitian-hukum-reports.edit', $report)); ?>" class="action-btn" style="color:#f59e0b;" title="Edit Laporan">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <button onclick="confirmDelete('<?php echo e(route('penelitian-hukum-reports.destroy', $report)); ?>')" class="action-btn" style="color:#ef4444;" title="Hapus Laporan">
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <a href="<?php echo e(route('penelitian-hukum-reports.create')); ?>" class="btn-cta" style="margin:auto;width:fit-content;">
    ...
    <script>
        function confirmDelete(action){
            if(!confirm('Hapus laporan Penelitian Hukum ini secara permanen?')) return;
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/penelitian_hukum_reports/index.blade.php ENDPATH**/ ?>