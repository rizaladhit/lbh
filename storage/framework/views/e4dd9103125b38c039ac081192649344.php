...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="specialization" type="text" class="form-control <?php $__errorArgs = ['specialization'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                name="specialization" value="<?php echo e(old('specialization')); ?>" placeholder="Contoh: Pendampingan masyarakat / Administrasi perkara" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php echo $__env->make('paralegals.partials.user-autofill', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
