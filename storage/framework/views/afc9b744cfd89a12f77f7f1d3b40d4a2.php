...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        Laporan Drafting Dokumen Hukum Form
     <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-10">
            <div class="card shadow-md border-0 mb-4 p-4 p-md-5" id="printableArea">
                ...
                <div class="card-header bg-transparent border-0 mb-4 pb-0 text-center">
                    <h5 class="fw-bold text-uppercase d-inline-block text-decoration-underline" style="text-underline-offset: 4px;">CHECK LIST BERKAS REIMBURSEMENT NON LITIGASI</h5>
                </div>
                <div class="card-body p-0" style="font-size: 0.95rem;">
                    ...
                    <div class="d-flex mb-1">
                        ...
                        <div class="w-100">: <?php echo e($draftingReport->penerima_bantuan); ?> <span class="float-end pe-5"><strong>L/P:</strong> <?php echo e($draftingReport->jk_penerima); ?></span></div>
                    </div>
                    <div class="d-flex mb-4">
                    ...
                    <table class="table table-bordered border-secondary align-middle mb-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="ps-4 border-bottom-0">- Biaya Drafter (diberi stempel OBH)</td>
                                <td class="text-center border-bottom-0"><span class="checklist-square"><?php echo $get_check($d, '5_1', 'obh'); ?></span></td>
                                <td class="text-center border-bottom-0"><span class="checklist-square"><?php echo $get_check($d, '5_1', 'kanwil'); ?></span></td>
                                <td class="text-center border-bottom-0"><span class="checklist-square"><?php echo $get_check($d, '5_1', 'bphn'); ?></span></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td class="ps-4">- Biaya penggandaan dan penjilidan laporan akhir</td>
