    ...
    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 class="mb-0 fw-bold text-body">Daftar Laporan Penyuluhan Hukum</h6>
            ...
            <table class="data-table table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="font-size:.82rem;" class="text-body"><?php echo e($report->narasumber ?? '-'); ?></div>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <h6 class="fw-bold text-body mb-1">Belum Ada Laporan Penyuluhan Hukum</h6>
