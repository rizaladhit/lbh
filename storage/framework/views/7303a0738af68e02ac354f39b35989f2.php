...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Edit Laporan Penelitian Hukum <?php $__env->endSlot(); ?>
        ...
        <div class="col-xl-9">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="<?php echo e(route('penelitian-hukum-reports.update', $penelitianHukumReport)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="obh" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('obh', $penelitianHukumReport->obh)); ?>" required>
                                <?php $__errorArgs = ['obh'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="alamat" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('alamat', $penelitianHukumReport->alamat)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="provinsi" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('provinsi', $penelitianHukumReport->provinsi)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="date" name="tgl_pelaksanaan" class="form-control ms-2 border-secondary border-opacity-50" style="max-width:220px;" value="<?php echo e(old('tgl_pelaksanaan', $penelitianHukumReport->tgl_pelaksanaan)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="judul_penelitian" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('judul_penelitian', $penelitianHukumReport->judul_penelitian)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php
                            $cl = old('checklist_data', $penelitianHukumReport->checklist_data ?? []);
                        ?>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="<?php echo e(route('penelitian-hukum-reports.show', $penelitianHukumReport)); ?>" class="btn btn-light border me-2 fw-medium">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/penelitian_hukum_reports/edit.blade.php ENDPATH**/ ?>