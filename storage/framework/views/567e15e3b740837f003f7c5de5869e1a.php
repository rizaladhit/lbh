...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Detail Laporan Penyuluhan Hukum <?php $__env->endSlot(); ?>
    ...
    <div class="d-print-none row justify-content-center">
        <div class="col-lg-10">
            <div class="card shadow-md border-0 mb-4 p-4 p-md-5">
                ...
                <div class="card-body p-0" style="font-size:0.95rem;">
                    <div class="d-flex mb-1">
                        ...
                        <div>: <?php echo e($penyuluhanHukumReport->obh); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">ALAMAT</div>
                        <div>: <?php echo e($penyuluhanHukumReport->alamat); ?></div>
                    </div>
                    <div class="d-flex mb-4">
                        <div class="fw-bold form-preview-label">PROVINSI</div>
                        <div>: <?php echo e($penyuluhanHukumReport->provinsi); ?></div>
                    </div>

                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">KEGIATAN</div>
                        <div class="text-uppercase">: <?php echo e($penyuluhanHukumReport->kegiatan); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">TGL PELAKSANAAN KEGIATAN</div>
                        <div>: <?php echo e($penyuluhanHukumReport->tgl_pelaksanaan?->format('d M Y') ?? '-'); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">PENERIMA BANTUAN HUKUM</div>
                        <div>: <?php echo e($penyuluhanHukumReport->penerima_bantuan ?? '-'); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">TEMPAT PELAKSANAAN KEG.</div>
                        <div>: <?php echo e($penyuluhanHukumReport->tempat_pelaksanaan ?? '-'); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">MATERI</div>
                        <div>: <?php echo e($penyuluhanHukumReport->materi ?? '-'); ?></div>
                    </div>
                    <div class="d-flex mb-4">
                        <div class="fw-bold form-preview-label">NARASUMBER</div>
                        <div>: <?php echo e($penyuluhanHukumReport->narasumber ?? '-'); ?></div>
                    </div>
                    ...
                    <table class="table table-bordered border-secondary align-middle mb-4" style="font-size:.88rem;">
                        ...
                        <tbody>
                            ...
                            <?php if($key === 'item8'): ?>
                                <?php $__currentLoopData = $item8_sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sk => $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td></td>
                                    <td class="ps-4 text-muted fw-medium"><?php echo e($letters[$sk]); ?>. &nbsp; <?php echo e($sl); ?></td>
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                <a href="<?php echo e(route('penyuluhan-hukum-reports.index')); ?>" class="btn btn-secondary px-4 fw-bold shadow-sm">Kembali</a>
                <a href="<?php echo e(route('penyuluhan-hukum-reports.edit', $penyuluhanHukumReport)); ?>" class="btn btn-warning px-4 fw-bold shadow-sm">
                    <i class="fa-solid fa-pen-to-square me-1"></i> Edit
                </a>
                <a href="<?php echo e(route('penyuluhan-hukum-reports.print', $penyuluhanHukumReport)); ?>" class="btn btn-success px-4 fw-bold shadow-sm">
    ...
    <div class="print-view">
        ...
        <div class="pv-group pv-g1">
            <div class="pv-row">
                ...
                <span class="pv-val"><?php echo e($penyuluhanHukumReport->obh); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">ALAMAT</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($penyuluhanHukumReport->alamat); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">PROVINSI</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($penyuluhanHukumReport->provinsi); ?></span>
            </div>
        </div>
        ...
        <div class="pv-group pv-g2">
            ...
            <div class="pv-row">
                ...
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($penyuluhanHukumReport->tgl_pelaksanaan?->format('d M Y')); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">PENERIMA BANTUAN HUKUM</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($penyuluhanHukumReport->penerima_bantuan); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">TEMPAT PELAKSANAAN KEG.</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($penyuluhanHukumReport->tempat_pelaksanaan); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">MATERI</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($penyuluhanHukumReport->materi); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">NARASUMBER</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($penyuluhanHukumReport->narasumber); ?></span>
            </div>
        </div>
        ...
        <table class="pv-table">
            ...
            <tbody>
                ...
                <?php if($key === 'item8'): ?>
                    <?php $__currentLoopData = $pv_item8_sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sk => $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td></td>
                        <td style="padding-left:20px;"><?php echo e($pv_letters[$sk]); ?>. &nbsp; <?php echo e($sl); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/penyuluhan_hukum_reports/show.blade.php ENDPATH**/ ?>