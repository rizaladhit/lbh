...
<head>
    <meta charset="utf-8">
    <title>Checklist Konsultasi Hukum - <?php echo e($konsultasiHukumReport->obh); ?></title>
    <style>
        @page {
            size: A4;
...
<body>
    ...
    <table class="info">
        <tr>
            <td class="lbl">OBH</td>
            <td class="sep">:</td>
            <td class="val"><?php echo e($konsultasiHukumReport->obh); ?></td>
        </tr>
        <tr>
            <td class="lbl">ALAMAT</td>
            <td class="sep">:</td>
            <td class="val"><?php echo e($konsultasiHukumReport->alamat); ?></td>
        </tr>
        <tr>
            <td class="lbl">PROVINSI</td>
            <td class="sep">:</td>
            <td class="val"><?php echo e($konsultasiHukumReport->provinsi); ?></td>
        </tr>
        <tr>
    ...
    <?php for($i = 0; $i < 5; $i++): ?>
        ...
        <div class="section-block <?php echo e(($i === 2 || $i === 4) ? 'page-break' : ''); ?>">
            <table class="info">
                <tr>
                    <td class="lbl">MATERI KONSULTASI <?php echo e($section_names[$i]); ?></td>
                    <td class="sep">:</td>
                    <td class="val"><?php echo e($sec['materi'] ?? ''); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="sep">:</td>
                    <td class="val"><?php echo e($sec['nama_konsultan'] ?? ''); ?></td>
                </tr>
            </table>
                ...
                <tbody>
                    <?php $__currentLoopData = $section_items[$i]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="chk-col"><?php echo e($chk($key, 'obh')); ?></td>
                            <td class="chk-col"><?php echo e($chk($key, 'kanwil')); ?></td>
                            <td class="chk-col"><?php echo e($chk($key, 'bphn')); ?></td>
                        </tr>
...
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/konsultasi_hukum_reports/pdf.blade.php ENDPATH**/ ?>