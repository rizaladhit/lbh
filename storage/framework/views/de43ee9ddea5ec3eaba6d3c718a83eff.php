...
<?php $component->withAttributes([]); ?>
    ...
    ?>
     <?php $__env->slot('header', null, []); ?> <?php echo e($isEdit ? 'Edit' : 'Buat'); ?> Laporan Penasehat Hukum - Lapas Subang <?php $__env->endSlot(); ?>

    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-sm border-0">
                <div class="card-header"><?php echo e($isEdit ? 'Edit' : 'Form'); ?> Laporan Lapas Subang</div>
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e($isEdit ? route('laporan-ph.lapas.update', $report) : route('laporan-ph.lapas.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <?php if($isEdit): ?>
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            <a href="<?php echo e(route('laporan-ph.lapas.index')); ?>" class="btn btn-light border">Kembali</a>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\lbh\resources\views/reports/ph/lapas.blade.php ENDPATH**/ ?>