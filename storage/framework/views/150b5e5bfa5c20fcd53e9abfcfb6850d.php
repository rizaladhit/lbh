                ...
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('laporan-ph.pengadilan.store')); ?>">
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            <a href="<?php echo e(route('laporan-ph.pengadilan.index')); ?>" class="btn btn-light border">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\reports\ph\pengadilan.blade.php ENDPATH**/ ?>