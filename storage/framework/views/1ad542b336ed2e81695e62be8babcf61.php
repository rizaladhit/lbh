...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Detail Laporan Pendampingan Diluar Pengadilan <?php $__env->endSlot(); ?>
    ...
    <div class="d-print-none row justify-content-center">
        <div class="col-lg-10">
            <div class="card shadow-md border-0 mb-4 p-4 p-md-5">
                ...
                <div class="card-body p-0" style="font-size:0.95rem;">
                    <div class="d-flex mb-1">
                        ...
                        <div>: <?php echo e($pendampinganReport->obh); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">ALAMAT</div>
                        <div>: <?php echo e($pendampinganReport->alamat); ?></div>
                    </div>
                    <div class="d-flex mb-4">
                        <div class="fw-bold form-preview-label">PROVINSI</div>
                        <div>: <?php echo e($pendampinganReport->provinsi); ?></div>
                    </div>

                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">KEGIATAN</div>
                        <div class="text-uppercase">: <?php echo e($pendampinganReport->kegiatan); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">KASUS</div>
                        <div>: <?php echo e($pendampinganReport->kasus); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">TGL PELAKSANAAN KEGIATAN</div>
                        <div>
                            <div>A. Pendampingan I: <?php echo e($pendampinganReport->tgl_pendampingan_1?->format('d M Y') ?? '-'); ?></div>
                            <div>B. Pendampingan II: <?php echo e($pendampinganReport->tgl_pendampingan_2?->format('d M Y') ?? '-'); ?></div>
                            <div>C. Pendampingan III: <?php echo e($pendampinganReport->tgl_pendampingan_3?->format('d M Y') ?? '-'); ?></div>
                            <div>D. Pendampingan IV: <?php echo e($pendampinganReport->tgl_pendampingan_4?->format('d M Y') ?? '-'); ?></div>
                        </div>
                    </div>
                    <div class="d-flex mb-4">
                        <div class="fw-bold form-preview-label">PENERIMA BANTUAN HUKUM</div>
                        <div class="w-100">: <?php echo e($pendampinganReport->penerima_bantuan); ?>

                            <span class="float-end pe-5"><strong>L/P:</strong> <?php echo e($pendampinganReport->jk_penerima); ?></span>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered border-secondary align-middle mb-4" style="font-size:.88rem;">
                        ...
                        <tbody>
                            ...
                            <?php if($key === 'item3'): ?>
                                <?php $__currentLoopData = $item3_sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sk => $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td></td>
                                    <td class="ps-4 text-muted fw-medium"><?php echo e($sl); ?></td>
                            ...
                            <?php endif; ?>
                            <?php if($key === 'item5'): ?>
                                <?php $__currentLoopData = $item5_sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sk => $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td></td>
                                    <td class="ps-4 text-muted fw-medium">- <?php echo e($sl); ?></td>
                                    <td class="text-center"><span class="checklist-square"><?php echo $chk($sk,'obh'); ?></span></td>
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                <a href="<?php echo e(route('pendampingan-reports.index')); ?>" class="btn btn-secondary px-4 fw-bold shadow-sm">Kembali</a>
                <a href="<?php echo e(route('pendampingan-reports.edit', $pendampinganReport)); ?>" class="btn btn-warning px-4 fw-bold shadow-sm">
                    <i class="fa-solid fa-pen-to-square me-1"></i> Edit
                </a>
                <a href="<?php echo e(route('pendampingan-reports.print', $pendampinganReport)); ?>" class="btn btn-success px-4 fw-bold shadow-sm">
    ...
    <div class="print-view">
        ...
        <div class="pv-group pv-g1">
            <div class="pv-row">
                ...
                <span class="pv-val"><?php echo e($pendampinganReport->obh); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">ALAMAT</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($pendampinganReport->alamat); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">PROVINSI</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($pendampinganReport->provinsi); ?></span>
            </div>
        </div>
        ...
        <div class="pv-group pv-g2">
            ...
            <div class="pv-row">
                ...
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($pendampinganReport->kasus); ?></span>
            </div>
            ...
            <div class="pv-row pv-row-top">
                ...
                <div class="pv-val-block">
                    <div class="pv-date-row">
                        ...
                        <span class="pv-date-val"><?php echo e($pendampinganReport->tgl_pendampingan_1?->format('d M Y')); ?></span>
                    </div>
                    <div class="pv-date-row">
                        <span class="pv-date-label">B. &nbsp; Pendampingan II: &nbsp; tanggal</span>
                        <span class="pv-date-val"><?php echo e($pendampinganReport->tgl_pendampingan_2?->format('d M Y')); ?></span>
                    </div>
                    <div class="pv-date-row">
                        <span class="pv-date-label">C. &nbsp; Pendampingan III: &nbsp; tanggal</span>
                        <span class="pv-date-val"><?php echo e($pendampinganReport->tgl_pendampingan_3?->format('d M Y')); ?></span>
                    </div>
                    <div class="pv-date-row">
                        <span class="pv-date-label">D. &nbsp; Pendampingan IV: &nbsp; tanggal</span>
                        <span class="pv-date-val"><?php echo e($pendampinganReport->tgl_pendampingan_4?->format('d M Y')); ?></span>
                    </div>
                </div>
            </div>
            <div class="pv-gap"></div>
            <div class="pv-row">
                ...
                <span class="pv-val" style="display:flex;justify-content:space-between;">
                    <span><?php echo e($pendampinganReport->penerima_bantuan); ?></span>
                    <strong>L/P : <?php echo e($pendampinganReport->jk_penerima); ?></strong>
                </span>
            </div>
        </div>
        ...
        <table class="pv-table">
            ...
            <tbody>
                ...
                <?php if($key === 'item3'): ?>
                    <?php $__currentLoopData = $pv_item3_sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sk => $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td></td>
                        <td style="padding-left:20px;"><?php echo $sl; ?></td>
                ...
                <?php endif; ?>
                <?php if($key === 'item5'): ?>
                    <?php $__currentLoopData = $pv_item5_sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sk => $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td></td>
        ...
        <?php echo $__env->make('partials.ketua-lbh-signature', ['space' => '42px', 'fixedBottom' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\pendampingan_reports\show.blade.php ENDPATH**/ ?>