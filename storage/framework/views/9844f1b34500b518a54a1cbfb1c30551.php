...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Detail Laporan Perdata <?php $__env->endSlot(); ?>
    ...
    <div class="d-print-none row justify-content-center">
        <div class="col-lg-10">
            <div class="card shadow-md border-0 mb-4 p-4 p-md-5">
                ...
                <div class="card-body p-0" style="font-size:0.95rem;">
                    <div class="d-flex mb-1">
                        ...
                        <div>: <?php echo e($perdataReport->obh); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">ALAMAT</div>
                        <div>: <?php echo e($perdataReport->alamat); ?></div>
                    </div>
                    <div class="d-flex mb-4">
                        <div class="fw-bold form-preview-label">PROVINSI</div>
                        <div>: <?php echo e($perdataReport->provinsi); ?></div>
                    </div>

                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">PERKARA</div>
                        <div class="text-uppercase fw-semibold">: <?php echo e($perdataReport->perkara); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">KASUS</div>
                        <div>: <?php echo e($perdataReport->kasus ?? '-'); ?></div>
                    </div>
                    <div class="d-flex mb-1">
                        <div class="fw-bold form-preview-label">NOMOR PERKARA</div>
                        <div>: <?php echo e($perdataReport->nomor_perkara ?? '-'); ?></div>
                    </div>
                    <div class="d-flex mb-4">
                        <div class="fw-bold form-preview-label">PENERIMA BANTUAN HUKUM</div>
                        <div class="w-100">: <?php echo e($perdataReport->penerima_bantuan ?? '-'); ?>

                            <span class="float-end pe-5"><strong>L/P:</strong> <?php echo e($perdataReport->jk_penerima ?? '-'); ?></span>
                        </div>
                    </div>
                            ...
                            <?php if($key === 'item14'): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="ps-3 text-muted">
                                        <?php echo e($letter); ?>. &nbsp; <?php echo e($cl[$sk]['text'] ?? ''); ?>
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                <a href="<?php echo e(route('perdata-reports.index')); ?>" class="btn btn-secondary px-4 fw-bold shadow-sm">Kembali</a>
                <a href="<?php echo e(route('perdata-reports.edit', $perdataReport)); ?>" class="btn btn-warning px-4 fw-bold shadow-sm">
                    <i class="fa-solid fa-pen-to-square me-1"></i> Edit
                </a>
                <a href="<?php echo e(route('perdata-reports.print', $perdataReport)); ?>" class="btn btn-success px-4 fw-bold shadow-sm">
    ...
    <div class="print-view">
        ...
        <div class="pv-group pv-g1">
            <div class="pv-row">
                ...
                <span class="pv-val"><?php echo e($perdataReport->obh); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">ALAMAT</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($perdataReport->alamat); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">PROVINSI</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($perdataReport->provinsi); ?></span>
            </div>
        </div>
        ...
        <div class="pv-group pv-g2">
            ...
            <div class="pv-row">
                ...
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($perdataReport->kasus); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">NOMOR PERKARA</span>
                <span class="pv-sep">:</span>
                <span class="pv-val"><?php echo e($perdataReport->nomor_perkara); ?></span>
            </div>
            <div class="pv-row">
                <span class="pv-label">PENERIMA BANTUAN HUKUM</span>
                <span class="pv-sep">:</span>
                <span class="pv-val" style="display:flex;justify-content:space-between;">
                    <span><?php echo e($perdataReport->penerima_bantuan); ?></span>
                    <strong>L/P : <?php echo e($perdataReport->jk_penerima); ?></strong>
                </span>
            </div>
        </div>
        ...
        <table class="pv-table">
            ...
            <tbody>
                ...
                <?php if($key === 'item14'): ?>
                    <?php $__currentLoopData = $pv_item14_sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sk => $letter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td></td>
                        <td>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/perdata_reports/show.blade.php ENDPATH**/ ?>