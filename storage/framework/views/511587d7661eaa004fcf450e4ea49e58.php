                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding-left:24px;">
                            <div style="font-size:.85rem;font-weight:600;" class="text-body"><?php echo e(Str::limit($report->kasus, 20)); ?></div>
                        ...
                        <td>
                            <div style="font-size:.85rem;font-weight:600;" class="text-body"><?php echo e($report->nama_drafter); ?></div>
                        </td>
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                ...
                                <a href="<?php echo e(route('drafting-reports.edit', $report)); ?>" class="action-btn" style="color:#f59e0b;" title="Edit Laporan">
