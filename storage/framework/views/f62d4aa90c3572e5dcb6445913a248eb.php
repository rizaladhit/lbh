            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4">
                    <p class="text-muted mb-4">
                        Anda akan menolak permohonan litigasi dari <strong><?php echo e($permohonanLitigasi->nama); ?></strong>
                        dengan nomor registrasi <strong><?php echo e($permohonanLitigasi->no_registrasi); ?></strong>.
                    </p>

                    <form method="POST" action="<?php echo e(route('permohonan-litigasi.storeReject', $permohonanLitigasi)); ?>" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                placeholder="Tuliskan alasan penolakan permohonan..."><?php echo e(old('verification_notes')); ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\permohonan\litigasi\reject.blade.php ENDPATH**/ ?>