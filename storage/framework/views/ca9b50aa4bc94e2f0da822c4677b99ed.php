...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Tambah Keahlian/Spesialisasi <?php $__env->endSlot(); ?>
        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('keahlian-spesialisasi.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                name="nama" value="<?php echo e(old('nama')); ?>" placeholder="Contoh: Hukum Pidana" required autofocus>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\keahlian-spesialisasi\create.blade.php ENDPATH**/ ?>