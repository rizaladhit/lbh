...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Master Keahlian/Spesialisasi <?php $__env->endSlot(); ?>
    ...
    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 style="font-size:.85rem;font-weight:600;" class="mb-0 fw-bold text-body">Daftar Keahlian/Spesialisasi</h6>
                    <div style="font-size:.72rem;color:#94a3b8;">Total <?php echo e($keahlians->count()); ?> keahlian terdaftar</div>
                </div>
            </div>
            <a href="<?php echo e(route('keahlian-spesialisasi.create')); ?>" class="btn-cta">
                <i class="fa-solid fa-plus"></i><span class="d-none d-sm-inline">Tambah Keahlian</span>
            </a>
        </div>
            ...
            <table class="data-table table">
                <thead>
                    <tr>
                        ...
                        <th>Nama Keahlian/Spesialisasi</th>
                        <th style="padding-right:24px;text-align:right;">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $keahlians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keahlian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td style="padding-left:24px;">
                            <span style="font-size:.8rem;color:#94a3b8;"><?php echo e($loop->iteration); ?></span>
                        </td>
                        <td>
                            <div style="font-size:.85rem;font-weight:600;" class="text-body"><?php echo e($keahlian->nama); ?></div>
                        </td>
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                <a href="<?php echo e(route('keahlian-spesialisasi.edit', $keahlian)); ?>" class="action-btn" style="color:#f59e0b;" title="Edit">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <form action="<?php echo e(route('keahlian-spesialisasi.destroy', $keahlian)); ?>" method="POST" style="display:inline;"
                                      onsubmit="return confirm('Hapus keahlian ini?')">
                                    <?php echo csrf_field(); ?>
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="empty-state">
                                ...
                                <h6 style="font-size:.85rem;font-weight:600;" class="fw-bold text-body mb-1">Belum Ada Keahlian/Spesialisasi</h6>
                                <p class="text-muted mb-4" style="font-size:.85rem;">Mulai dengan menambahkan keahlian yang pertama.</p>
                                <a href="<?php echo e(route('keahlian-spesialisasi.create')); ?>" class="btn-cta" style="margin:auto;width:fit-content;">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/keahlian-spesialisasi/index.blade.php ENDPATH**/ ?>