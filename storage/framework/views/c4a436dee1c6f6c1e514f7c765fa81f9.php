                ...
                <div class="card-body p-3">
                    <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center gap-3">
                        ...
                        <div class="d-flex flex-wrap gap-2 justify-content-start justify-content-md-end">
                            <a href="<?php echo e(route('permohonan-non-litigasi.edit', $permohonanNonLitigasi)); ?>" class="btn btn-sm btn-secondary">Edit</a>
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-3 p-md-4" style="font-size: 0.95rem;">
                    ...
                    <div class="d-flex flex-column flex-md-row border-bottom py-2">
                        ...
                        <div class="text-muted"><span class="d-md-none">: </span><span class="d-none d-md-inline">: </span><?php echo e($permohonanNonLitigasi->verification_notes); ?></div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-flex flex-column flex-md-row border-bottom py-2">
                        ...
                        <div class="text-muted"><span class="d-md-none">: </span><span class="d-none d-md-inline">: </span><?php echo e($permohonanNonLitigasi->assignedLawyer->name); ?></div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-flex flex-column flex-md-row border-bottom py-2">
                        ...
                        <div class="text-muted"><span class="d-md-none">: </span><span class="d-none d-md-inline">: </span><?php echo e($permohonanNonLitigasi->assignedParalegal->name); ?></div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-flex flex-column flex-md-row border-bottom py-2">
                        ...
                        <div class="text-muted"><span class="d-md-none">: </span><span class="d-none d-md-inline">: </span><?php echo e($permohonanNonLitigasi->activity_notes); ?></div>
                    </div>
                    <?php endif; ?>
