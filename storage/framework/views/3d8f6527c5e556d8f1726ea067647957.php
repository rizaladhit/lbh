...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="role" name="role" class="form-select" required>
                                ...
                                <option value="pengacara" <?php echo e(old('role') == 'pengacara' ? 'selected' : ''); ?>>Advocate</option>
                                <option value="paralegal" <?php echo e(old('role') == 'paralegal' ? 'selected' : ''); ?>>Paralegal</option>
                            </select>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/users/create.blade.php ENDPATH**/ ?>