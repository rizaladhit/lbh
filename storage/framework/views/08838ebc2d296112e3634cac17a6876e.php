...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Tambah Data Lawyer Baru <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                name="name" value="<?php echo e(old('name')); ?>" placeholder="Pilih akun pengacara terlebih dahulu" required autofocus>
...
unset($__errorArgs, $__bag); ?>" 
                                name="notes" rows="2" placeholder="Catatan tambahan tentang lawyer"><?php echo e(old('notes')); ?></textarea>
