...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Edit Laporan Pemberdayaan Masyarakat <?php $__env->endSlot(); ?>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form method="POST" action="<?php echo e(route('pemberdayaan-masyarakat.update', $reimbursementReport)); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="date" name="tgl_pelaksanaan" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('tgl_pelaksanaan', optional($reimbursementReport->tgl_pelaksanaan)->format('Y-m-d'))); ?>" style="max-width: 220px;" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="penerima_bantuan" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('penerima_bantuan', $reimbursementReport->penerima_bantuan)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="tempat_pelaksanaan" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('tempat_pelaksanaan', $reimbursementReport->tempat_pelaksanaan)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="materi" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('materi', $reimbursementReport->materi)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="narasumber" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('narasumber', $reimbursementReport->narasumber)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <table class="table table-bordered align-middle">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $checklist = old('checklist_data', $reimbursementReport->checklist_data ?? []);
                                        $isChecked = function ($key, $field) use ($checklist) {
                                            return !empty($checklist[$key][$field]);
                                        };
                                    ?>
                                    ...
                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <?php if($key !== 'item8'): ?>
                                                <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[<?php echo e($key); ?>][obh]" value="1" <?php echo e($isChecked($key, 'obh') ? 'checked' : ''); ?>></td>
                                                <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[<?php echo e($key); ?>][kanwil]" value="1" <?php echo e($isChecked($key, 'kanwil') ? 'checked' : ''); ?>></td>
                                                <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[<?php echo e($key); ?>][bphn]" value="1" <?php echo e($isChecked($key, 'bphn') ? 'checked' : ''); ?>></td>
                                            <?php else: ?>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                        ...
                                        <?php if($key === 'item8'): ?>
                                            <?php $__currentLoopData = $subitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subkey => $sublabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td></td>
                                                    <td class="ps-4 text-muted fw-medium">- <?php echo e($sublabel); ?><input type="hidden" name="checklist_data[<?php echo e($subkey); ?>][label]" value="<?php echo e($sublabel); ?>"></td>
                                                    <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[<?php echo e($subkey); ?>][obh]" value="1" <?php echo e($isChecked($subkey, 'obh') ? 'checked' : ''); ?>></td>
                                                    <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[<?php echo e($subkey); ?>][kanwil]" value="1" <?php echo e($isChecked($subkey, 'kanwil') ? 'checked' : ''); ?>></td>
                                                    <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[<?php echo e($subkey); ?>][bphn]" value="1" <?php echo e($isChecked($subkey, 'bphn') ? 'checked' : ''); ?>></td>
                                                </tr>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="<?php echo e(route('pemberdayaan-masyarakat.show', $reimbursementReport)); ?>" class="btn btn-light border me-2 fw-medium">Batal</a>
                            <button type="submit" class="btn btn-primary fw-bold px-4 shadow-sm"><i class="fa-solid fa-save me-1"></i> Simpan Perubahan</button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/reimbursement_reports/edit_pemberdayaan.blade.php ENDPATH**/ ?>