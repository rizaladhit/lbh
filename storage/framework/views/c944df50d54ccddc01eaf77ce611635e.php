        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="<?php echo e(route('negosiasi-reports.update', $negosiasiReport)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="obh" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('obh', $negosiasiReport->obh)); ?>" required>
                                <?php $__errorArgs = ['obh'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="alamat" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('alamat', $negosiasiReport->alamat)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="provinsi" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('provinsi', $negosiasiReport->provinsi)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="date" name="tgl_pelaksanaan" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('tgl_pelaksanaan', $negosiasiReport->tgl_pelaksanaan)); ?>" style="max-width: 220px;" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="kasus" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('kasus', $negosiasiReport->kasus)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="penerima_bantuan" class="form-control mx-2 border-secondary border-opacity-50" value="<?php echo e(old('penerima_bantuan', $negosiasiReport->penerima_bantuan)); ?>" required>
                                <select name="jk_penerima" class="form-select w-auto border-secondary border-opacity-50" required>
                                    <option value="" <?php echo e(old('jk_penerima', $negosiasiReport->jk_penerima) == '' ? 'selected' : ''); ?>>L/P</option>
                                    <option value="L" <?php echo e(old('jk_penerima', $negosiasiReport->jk_penerima) == 'L' ? 'selected' : ''); ?>>L</option>
                                    <option value="P" <?php echo e(old('jk_penerima', $negosiasiReport->jk_penerima) == 'P' ? 'selected' : ''); ?>>P</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="nama_negosiator" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('nama_negosiator', $negosiasiReport->nama_negosiator)); ?>" required>
                                <?php $__errorArgs = ['nama_negosiator'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-danger small ms-3"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php $__currentLoopData = $berkas_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="fw-medium"><?php echo e($label); ?>
                                                ...
                                                <input type="hidden" name="checklist[<?php echo e($idx); ?>][label]" value="<?php echo e($label); ?>">
                                            </td>
                                            <td class="text-center">
                                                <input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist[<?php echo e($idx); ?>][obh]" value="1" <?php echo e(!empty($cl[$idx]['obh']) ? 'checked' : ''); ?>>
                                            </td>
                                            <td class="text-center">
                                                <input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist[<?php echo e($idx); ?>][kanwil]" value="1" <?php echo e(!empty($cl[$idx]['kanwil']) ? 'checked' : ''); ?>>
                                            </td>
                                            <td class="text-center">
                                                <input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist[<?php echo e($idx); ?>][bphn]" value="1" <?php echo e(!empty($cl[$idx]['bphn']) ? 'checked' : ''); ?>>
                                            </td>
                                        </tr>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="<?php echo e(route('negosiasi-reports.show', $negosiasiReport)); ?>" class="btn btn-light border me-2 fw-medium">Batal</a>
