...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        Verifikasi Permohonan Litigasi
     <?php $__env->endSlot(); ?>
        ...
        <div class="col-xl-8">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header py-3 bg-success">
                    <h6 class="m-0 fw-bold text-white"><i class="fa-solid fa-check-circle me-2"></i>Verifikasi Permohonan Litigasi</h6>
                </div>
                <div class="card-body p-4">
                    <p class="text-muted mb-4">
                        Anda akan memverifikasi permohonan litigasi dari <strong><?php echo e($permohonanLitigasi->nama); ?></strong> 
                        dengan nomor registrasi <strong><?php echo e($permohonanLitigasi->no_registrasi); ?></strong>.
                    </p>

                    <form method="POST" action="<?php echo e(route('permohonan-litigasi.storeVerify', $permohonanLitigasi)); ?>" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/permohonan/litigasi/verify.blade.php ENDPATH**/ ?>