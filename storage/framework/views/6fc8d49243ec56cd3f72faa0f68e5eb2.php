...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Master Status Perkara <?php $__env->endSlot(); ?>
    ...
    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 style="font-size:.85rem;font-weight:600;" class="mb-0 fw-bold text-body">Daftar Status Perkara</h6>
                    <div style="font-size:.72rem;color:#94a3b8;">Total <?php echo e($statusPerkaras->count()); ?> status terdaftar</div>
                </div>
            </div>
            <a href="<?php echo e(route('status-perkara.create')); ?>" class="btn-cta">
                <i class="fa-solid fa-plus"></i><span class="d-none d-sm-inline">Tambah Status</span>
            </a>
        </div>
        ...
        <div class="table-responsive">
            <table class="data-table table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $statusPerkaras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td style="padding-left:24px;">
                            <span style="font-size:.8rem;color:#94a3b8;"><?php echo e($loop->iteration); ?></span>
                        </td>
                        <td>
                            <div style="font-size:.85rem;font-weight:600;" class="text-body"><?php echo e($sp->nama); ?></div>
                        </td>
                        <td>
                            <span class="<?php echo e($sp->getBadgeClass()); ?>"><?php echo e($sp->nama); ?></span>
                        </td>
                        <td>
                            <?php if($sp->is_final): ?>
                        ...
                        <td>
                            <span style="font-size:.85rem;" class="text-body"><?php echo e($sp->urutan); ?></span>
                        </td>
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                <a href="<?php echo e(route('status-perkara.edit', $sp)); ?>" class="action-btn" style="color:#f59e0b;" title="Edit">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <form action="<?php echo e(route('status-perkara.destroy', $sp)); ?>" method="POST" style="display:inline;"
                                      onsubmit="return confirm('Hapus status perkara ini?')">
                                    <?php echo csrf_field(); ?>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <h6 style="font-size:.85rem;font-weight:600;" class="fw-bold text-body mb-1">Belum Ada Status Perkara</h6>
                                <p class="text-muted mb-4" style="font-size:.85rem;">Mulai dengan menambahkan status perkara yang pertama.</p>
                                <a href="<?php echo e(route('status-perkara.create')); ?>" class="btn-cta" style="margin:auto;width:fit-content;">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/status-perkara/index.blade.php ENDPATH**/ ?>