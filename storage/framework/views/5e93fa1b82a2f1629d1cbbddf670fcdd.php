...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Edit Laporan Konsultasi Hukum <?php $__env->endSlot(); ?>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="<?php echo e(route('konsultasi-hukum-reports.update', $konsultasiHukumReport)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="obh" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('obh', $konsultasiHukumReport->obh)); ?>" required>
                                <?php $__errorArgs = ['obh'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="alamat" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('alamat', $konsultasiHukumReport->alamat)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="provinsi" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('provinsi', $konsultasiHukumReport->provinsi)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php for($i = 0; $i < 5; $i++): ?>
                        <?php $sec = $konsultasiHukumReport->sections[$i] ?? []; ?>
                        <div class="border rounded p-4 mb-4" style="background: var(--bs-secondary-bg);">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-7 d-flex align-items-center">
                                    : <input type="text" name="sections[<?php echo e($i); ?>][materi]" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('sections.'.$i.'.materi', $sec['materi'] ?? '')); ?>">
                                </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7 d-flex align-items-center">
                                    : <input type="text" name="sections[<?php echo e($i); ?>][nama_konsultan]" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('sections.'.$i.'.nama_konsultan', $sec['nama_konsultan'] ?? '')); ?>">
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="sections[<?php echo e($i); ?>][checklist][<?php echo e($key); ?>][obh]" value="1" <?php echo e(old('sections.'.$i.'.checklist.'.$key.'.obh', $sec['checklist'][$key]['obh'] ?? '') ? 'checked' : ''); ?>></td>
                                            <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="sections[<?php echo e($i); ?>][checklist][<?php echo e($key); ?>][kanwil]" value="1" <?php echo e(old('sections.'.$i.'.checklist.'.$key.'.kanwil', $sec['checklist'][$key]['kanwil'] ?? '') ? 'checked' : ''); ?>></td>
                                            <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="sections[<?php echo e($i); ?>][checklist][<?php echo e($key); ?>][bphn]" value="1" <?php echo e(old('sections.'.$i.'.checklist.'.$key.'.bphn', $sec['checklist'][$key]['bphn'] ?? '') ? 'checked' : ''); ?>></td>
                                        </tr>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="<?php echo e(route('konsultasi-hukum-reports.show', $konsultasiHukumReport)); ?>" class="btn btn-light border me-2 fw-medium">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\konsultasi_hukum_reports\edit.blade.php ENDPATH**/ ?>