...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Tambah Jenis Pelayanan <?php $__env->endSlot(); ?>
    ...
    <div class="card shadow-sm border-0 mb-4">
        ...
        <div class="card-body p-4">
            <form action="<?php echo e(route('jenis-pelayanan.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('nama')); ?>" placeholder="Contoh: Konsultasi Hukum" required>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\jenis-pelayanan\create.blade.php ENDPATH**/ ?>