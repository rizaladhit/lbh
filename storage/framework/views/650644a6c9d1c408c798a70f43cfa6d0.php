...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Detail Laporan TUN <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-10">
            <div class="card shadow-md border-0 mb-4 p-4 p-md-5">
                ...
                <div class="card-body p-0" style="font-size:0.95rem;">
                    <div class="d-flex mb-1"><div class="fw-bold form-preview-label">OBH</div><div>: <?php echo e($tunReport->obh); ?></div></div>
                    <div class="d-flex mb-1"><div class="fw-bold form-preview-label">ALAMAT</div><div>: <?php echo e($tunReport->alamat); ?></div></div>
                    <div class="d-flex mb-4"><div class="fw-bold form-preview-label">PROVINSI</div><div>: <?php echo e($tunReport->provinsi); ?></div></div>

                    <div class="d-flex mb-1"><div class="fw-bold form-preview-label">PERKARA</div><div class="text-uppercase fw-semibold">: <?php echo e($tunReport->perkara); ?></div></div>
                    <div class="d-flex mb-1"><div class="fw-bold form-preview-label">KASUS</div><div>: <?php echo e($tunReport->kasus ?? '-'); ?></div></div>
                    <div class="d-flex mb-1"><div class="fw-bold form-preview-label">NOMOR PERKARA</div><div>: <?php echo e($tunReport->nomor_perkara ?? '-'); ?></div></div>
                    <div class="d-flex mb-4">
                        <div class="fw-bold form-preview-label">PENERIMA BANTUAN HUKUM</div>
                        <div class="w-100">: <?php echo e($tunReport->penerima_bantuan ?? '-'); ?>

                            <span class="float-end pe-5"><strong>L/P:</strong> <?php echo e($tunReport->jk_penerima ?? '-'); ?></span>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                <a href="<?php echo e(route('tun-reports.index')); ?>" class="btn btn-secondary px-4 fw-bold shadow-sm">Kembali</a>
                <a href="<?php echo e(route('tun-reports.edit', $tunReport)); ?>" class="btn btn-warning px-4 fw-bold shadow-sm">
                    <i class="fa-solid fa-pen-to-square me-1"></i> Edit
                </a>
                <a href="<?php echo e(route('tun-reports.print', $tunReport)); ?>" class="btn btn-success px-4 fw-bold shadow-sm">
    ...
    <div class="print-view">
        ...
        <div class="pv-group pv-g1">
            <div class="pv-row"><span class="pv-label">OBH</span><span class="pv-sep">:</span><span class="pv-val"><?php echo e($tunReport->obh); ?></span></div>
            <div class="pv-row"><span class="pv-label">ALAMAT</span><span class="pv-sep">:</span><span class="pv-val"><?php echo e($tunReport->alamat); ?></span></div>
            <div class="pv-row"><span class="pv-label">PROVINSI</span><span class="pv-sep">:</span><span class="pv-val"><?php echo e($tunReport->provinsi); ?></span></div>
        </div>
        ...
        <div class="pv-group pv-g2">
            ...
            <div class="pv-row"><span class="pv-label">KASUS</span><span class="pv-sep">:</span><span class="pv-val"><?php echo e($tunReport->kasus); ?></span></div>
            <div class="pv-row"><span class="pv-label">NOMOR PERKARA</span><span class="pv-sep">:</span><span class="pv-val"><?php echo e($tunReport->nomor_perkara); ?></span></div>
            <div class="pv-row">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/tun_reports/show.blade.php ENDPATH**/ ?>