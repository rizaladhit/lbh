...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Tambah Status Perkara <?php $__env->endSlot(); ?>
    ...
    <div class="card shadow-sm border-0 mb-4">
        ...
        <div class="card-body p-4">
            <form action="<?php echo e(route('status-perkara.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('nama')); ?>" placeholder="Contoh: Sidang Pertama" required>
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="secondary" <?php echo e(old('warna', 'secondary') === 'secondary' ? 'selected' : ''); ?>>Abu-abu (secondary)</option>
                            <option value="info"      <?php echo e(old('warna') === 'info'      ? 'selected' : ''); ?>>Biru (info)</option>
                            <option value="warning"   <?php echo e(old('warna') === 'warning'   ? 'selected' : ''); ?>>Kuning (warning)</option>
                            <option value="danger"    <?php echo e(old('warna') === 'danger'    ? 'selected' : ''); ?>>Merah (danger)</option>
                            <option value="success"   <?php echo e(old('warna') === 'success'   ? 'selected' : ''); ?>>Hijau (success)</option>
                            <option value="primary"   <?php echo e(old('warna') === 'primary'   ? 'selected' : ''); ?>>Ungu (primary)</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('urutan', 0)); ?>" min="0" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_final" id="is_final" value="1"
                                   <?php echo e(old('is_final') ? 'checked' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/status-perkara/create.blade.php ENDPATH**/ ?>