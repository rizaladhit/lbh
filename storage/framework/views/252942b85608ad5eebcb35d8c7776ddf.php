...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Laporan Konsultasi Hukum <?php $__env->endSlot(); ?>
    ...
    <style>
        ...
        .badge-keg { background: rgba(16,185,129,.12); color: #059669; padding: 4px 10px; border-radius: 99px; font-size: .7rem; font-weight: 700; display: inline-block; }
    </style>
    ...
    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 class="mb-0 fw-bold text-body">Daftar Laporan Konsultasi Hukum</h6>
                    <div style="font-size:.72rem;color:#94a3b8;">Total <?php echo e($reports->total()); ?> laporan terdata</div>
                </div>
            </div>
            <a href="<?php echo e(route('konsultasi-hukum-reports.create')); ?>" class="btn-cta">
        ...
        <div class="table-responsive">
            <table class="data-table table">
                <thead>
                    <tr>
                        <th style="padding-left:24px;">OBH</th>
                        <th>Provinsi</th>
                        <th>Kegiatan</th>
                        <th>Materi I</th>
                        <th>Status</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="font-size:.82rem;" class="text-body"><?php echo e(Str::limit($secs[0]['materi'] ?? '-', 30)); ?></div>
                        </td>
                        <td>
                        ...
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                <a href="<?php echo e(route('konsultasi-hukum-reports.show', $report)); ?>" class="action-btn" style="color:#6366f1;" title="Detail Laporan">
                                    <i class="fa-solid fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('konsultasi-hukum-reports.edit', $report)); ?>" class="action-btn" style="color:#f59e0b;" title="Edit Laporan">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <button onclick="confirmDelete('<?php echo e(route('konsultasi-hukum-reports.destroy', $report)); ?>')" class="action-btn" style="color:#ef4444;" title="Hapus Laporan">
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <h6 class="fw-bold text-body mb-1">Belum Ada Laporan Konsultasi Hukum</h6>
                                <p class="text-muted mb-4" style="font-size:.85rem;">Mulai dengan membuat laporan Konsultasi Hukum yang pertama.</p>
                                <a href="<?php echo e(route('konsultasi-hukum-reports.create')); ?>" class="btn-cta" style="margin:auto;width:fit-content;">
    ...
    <script>
        function confirmDelete(action){
            if(!confirm('Hapus laporan Konsultasi Hukum ini secara permanen?')) return;
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/konsultasi_hukum_reports/index.blade.php ENDPATH**/ ?>