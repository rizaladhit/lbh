...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Edit Laporan Pendampingan Diluar Pengadilan <?php $__env->endSlot(); ?>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="<?php echo e(route('pendampingan-reports.update', $pendampinganReport)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="obh" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('obh', $pendampinganReport->obh)); ?>" required>
                                <?php $__errorArgs = ['obh'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="alamat" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('alamat', $pendampinganReport->alamat)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="provinsi" class="form-control border-secondary border-opacity-50" value="<?php echo e(old('provinsi', $pendampinganReport->provinsi)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="kasus" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('kasus', $pendampinganReport->kasus)); ?>" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 ps-3">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <input type="date" name="tgl_pendampingan_<?php echo e($num); ?>" class="form-control border-secondary border-opacity-50" style="max-width:200px;" value="<?php echo e(old('tgl_pendampingan_'.$num, $pendampinganReport->{'tgl_pendampingan_'.$num})); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="penerima_bantuan" class="form-control mx-2 border-secondary border-opacity-50" value="<?php echo e(old('penerima_bantuan', $pendampinganReport->penerima_bantuan)); ?>" required>
                                <select name="jk_penerima" class="form-select w-auto border-secondary border-opacity-50" required>
                                    <option value="">L/P</option>
                                    <option value="L" <?php echo e(old('jk_penerima', $pendampinganReport->jk_penerima) == 'L' ? 'selected' : ''); ?>>L</option>
                                    <option value="P" <?php echo e(old('jk_penerima', $pendampinganReport->jk_penerima) == 'P' ? 'selected' : ''); ?>>P</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php
                            $cl = old('checklist_data', $pendampinganReport->checklist_data ?? []);
                        ?>
                            ...
                            <table class="table table-bordered align-middle">
                                ...
                                <tbody>
                                    ...
                                    <?php if($key === 'item5'): ?>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td class="ps-4 text-muted fw-medium">- <?php echo e($sublabel); ?>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="<?php echo e(route('pendampingan-reports.show', $pendampinganReport)); ?>" class="btn btn-light border me-2 fw-medium">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\pendampingan_reports\edit.blade.php ENDPATH**/ ?>