        ...
        <div class="col-xl-9">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="<?php echo e(route('negosiasi-reports.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="nama_negosiator" class="form-control ms-2 border-secondary border-opacity-50" value="<?php echo e(old('nama_negosiator')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php $__currentLoopData = $berkas_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist[<?php echo e($idx); ?>][obh]" value="1" <?php echo e(old('checklist.'.$idx.'.obh') ? 'checked' : ''); ?>>
                                            </td>
                                            <td class="text-center">
                                                <input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist[<?php echo e($idx); ?>][kanwil]" value="1" <?php echo e(old('checklist.'.$idx.'.kanwil') ? 'checked' : ''); ?>>
                                            </td>
                                            <td class="text-center">
                                                <input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist[<?php echo e($idx); ?>][bphn]" value="1" <?php echo e(old('checklist.'.$idx.'.bphn') ? 'checked' : ''); ?>>
                                            </td>
                                        </tr>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="<?php echo e(route('negosiasi-reports.index')); ?>" class="btn btn-light border me-2 fw-medium">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/negosiasi_reports/create.blade.php ENDPATH**/ ?>