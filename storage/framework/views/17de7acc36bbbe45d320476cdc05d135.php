    ...
    <div style="max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; padding: 24px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
            ...
            <tr>
                ...
                <td style="padding: 8px; border-bottom: 1px solid #e5e7eb;"><?php echo e($permohonanLitigasi->nama); ?></td>
            </tr>
            <tr>
                <td style="padding: 8px; border-bottom: 1px solid #e5e7eb; font-weight: bold;">NIK</td>
                <td style="padding: 8px; border-bottom: 1px solid #e5e7eb;"><?php echo e($permohonanLitigasi->nik); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding: 8px; border-bottom: 1px solid #e5e7eb;"><?php echo e(optional($permohonanLitigasi->tgl_rencana_kunjungan)->format('d/m/Y') ?? '-'); ?></td>
            </tr>
            <tr>
                <td style="padding: 8px; border-bottom: 1px solid #e5e7eb; font-weight: bold;">Tanggal Dikirim</td>
                <td style="padding: 8px; border-bottom: 1px solid #e5e7eb;"><?php echo e($permohonanLitigasi->created_at->format('d/m/Y H:i')); ?></td>
            </tr>
        </table>
        ...
        <p style="margin: 24px 0;">
            <a href="<?php echo e(route('permohonan-litigasi.show', $permohonanLitigasi)); ?>" style="display: inline-block; background: #6366f1; color: #ffffff; text-decoration: none; padding: 10px 16px; border-radius: 6px; font-weight: bold;">
                Lihat Permohonan
            </a>
        </p>
...
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/emails/permohonan-litigasi-submitted.blade.php ENDPATH**/ ?>