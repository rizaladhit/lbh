    ...
    <div class="page">
        ...
        <table>
            <tbody>
                <tr>
                    <th>Nama</th>
                    <td><?php echo e($permohonanLitigasi->nama); ?></td>
                </tr>
                <tr>
                    <th>NIK</th>
                    <td><?php echo e($permohonanLitigasi->nik); ?></td>
                </tr>
                <tr>
                    <th>Alamat</th>
                    <td><?php echo e($permohonanLitigasi->alamat); ?></td>
                </tr>
                <tr>
                    <th>Telp / HP</th>
                    <td><?php echo e($permohonanLitigasi->telp_hp); ?></td>
                </tr>
            </tbody>
        </table>
        ...
        <table>
            <tbody>
                <tr>
                    <th>Jenis Perkara</th>
                    <td><?php echo e($permohonanLitigasi->jenis_perkara); ?></td>
                </tr>
                <tr>
                    <th>No. Perkara</th>
                    <td><?php echo e($permohonanLitigasi->no_perkara); ?></td>
                </tr>
                <tr>
                    <th>Tgl. Rencana Kunjungan</th>
                    <td><?php echo e($permohonanLitigasi->tgl_rencana_kunjungan->format('d M Y')); ?></td>
                </tr>
                <tr>
        ...
        <?php if($permohonanLitigasi->file_ktp_kk): ?>
            ...
            <?php else: ?>
                <p style="font-size: 11pt; color:#555;">[File PDF terlampir – <?php echo e(basename($permohonanLitigasi->file_ktp_kk)); ?>]
                </p>
            <?php endif; ?>
        <?php endif; ?>
        ...
        <?php if($permohonanLitigasi->file_sktm): ?>
            ...
            <?php else: ?>
                <p style="font-size: 11pt; color:#555;">[File PDF terlampir – <?php echo e(basename($permohonanLitigasi->file_sktm)); ?>]
                </p>
            <?php endif; ?>
        <?php endif; ?>
