            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4">
                    <p class="text-muted mb-4">
                        Anda akan menolak permohonan non-litigasi dari <strong><?php echo e($permohonanNonLitigasi->nama_pemohon); ?></strong>
                        dengan nomor registrasi <strong><?php echo e($permohonanNonLitigasi->no_registrasi); ?></strong>.
                    </p>

                    <form method="POST" action="<?php echo e(route('permohonan-non-litigasi.storeReject', $permohonanNonLitigasi)); ?>" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/permohonan/non_litigasi/reject.blade.php ENDPATH**/ ?>