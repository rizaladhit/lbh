...
<head>
    ...
    <title><?php echo e(config('app.name', 'LBH')); ?> — Panel</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-logo">
        <div class="sidebar-logo-icon">
            <?php if(isset($appSetting) && $appSetting->logo_path): ?>
                <img src="<?php echo e(Storage::url($appSetting->logo_path)); ?>" alt="Logo" style="height:22px;width:22px;object-fit:contain;">
            <?php else: ?>
                <i class="fa-solid fa-scale-balanced text-white" style="font-size:.85rem;"></i>
            <?php endif; ?>
        </div>
        <div>
            <div class="sidebar-logo-text"><?php echo e(isset($appSetting) ? $appSetting->app_name : 'LBH'); ?></div>
            <div class="sidebar-logo-sub"><?php echo e(isset($appSetting) && $appSetting->description ? $appSetting->description : 'Sistem Manajemen Bantuan Hukum'); ?></div>
        </div>
    </a>
    ...
    <div style="flex:1;padding-top:8px;">
        ...
        <div class="nav-item-custom">
            <a href="<?php echo e(route('dashboard')); ?>"
               class="nav-link-custom <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
                <div class="nav-icon" style="background:<?php echo e(request()->routeIs('dashboard') ? 'rgba(99,102,241,.15)' : 'rgba(100,116,139,.08)'); ?>;">
                    <i class="fa-solid fa-chart-pie" style="color:<?php echo e(request()->routeIs('dashboard') ? 'var(--brand-1)' : '#64748b'); ?>;"></i>
                </div>
                Dashboard
            </a>
        </div>
        ...
        <!-- Permohonan Submenu -->
        <div class="nav-item-custom">
            <button class="nav-link-custom <?php echo e(request()->routeIs('permohonan-*') ? 'active' : ''); ?>"
                    onclick="toggleSubmenu('permohonanMenu', this)">
                <div class="nav-icon" style="background:<?php echo e(request()->routeIs('permohonan-*') ? 'rgba(16,185,129,.15)' : 'rgba(100,116,139,.08)'); ?>;">
                    <i class="fa-solid fa-file-pen" style="color:<?php echo e(request()->routeIs('permohonan-*') ? '#10b981' : '#64748b'); ?>;"></i>
                </div>
                Form Permohonan
                <i class="fa-solid fa-chevron-right ms-auto" style="font-size:.6rem;transition:var(--trans);" id="permohonanMenuArrow"></i>
            </button>
            <div class="submenu-wrap" id="permohonanMenu" style="display:<?php echo e(request()->routeIs('permohonan-*') ? 'block' : 'none'); ?>;">
                <div class="submenu-inner">
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('permohonan-litigasi.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('permohonan-litigasi.*') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-scale-balanced me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Bantuan Litigasi
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('permohonan-non-litigasi.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('permohonan-non-litigasi.*') ? 'active' : ''); ?>">
        ...
        <div class="nav-item-custom">
            <button class="nav-link-custom <?php echo e(request()->routeIs('drafting-reports.*') || request()->routeIs('mediasi-reports.*') || request()->routeIs('negosiasi-reports.*') || request()->routeIs('pemberdayaan-masyarakat.*') || request()->routeIs('reimbursement-reports.create-pemberdayaan') || request()->routeIs('pendampingan-reports.*') || request()->routeIs('penelitian-hukum-reports.*') || request()->routeIs('penyuluhan-hukum-reports.*') || request()->routeIs('perdata-reports.*') || request()->routeIs('pidana-reports.*') || request()->routeIs('tun-reports.*') || request()->routeIs('konsultasi-hukum-reports.*') || request()->routeIs('investigasi-kasus-reports.*') ? 'active' : ''); ?>"
                ...
                <div class="nav-icon" style="background:<?php echo e(request()->routeIs('drafting-reports.*') || request()->routeIs('mediasi-reports.*') || request()->routeIs('negosiasi-reports.*') || request()->routeIs('pemberdayaan-masyarakat.*') || request()->routeIs('reimbursement-reports.create-pemberdayaan') || request()->routeIs('pendampingan-reports.*') || request()->routeIs('penelitian-hukum-reports.*') || request()->routeIs('penyuluhan-hukum-reports.*') || request()->routeIs('perdata-reports.*') || request()->routeIs('pidana-reports.*') || request()->routeIs('tun-reports.*') || request()->routeIs('konsultasi-hukum-reports.*') || request()->routeIs('investigasi-kasus-reports.*') ? 'rgba(99,102,241,.15)' : 'rgba(100,116,139,.08)'); ?>;">
                    <i class="fa-solid fa-book-bookmark" style="color:<?php echo e(request()->routeIs('drafting-reports.*') || request()->routeIs('mediasi-reports.*') || request()->routeIs('negosiasi-reports.*') || request()->routeIs('pemberdayaan-masyarakat.*') || request()->routeIs('reimbursement-reports.create-pemberdayaan') || request()->routeIs('pendampingan-reports.*') || request()->routeIs('penelitian-hukum-reports.*') || request()->routeIs('penyuluhan-hukum-reports.*') || request()->routeIs('perdata-reports.*') || request()->routeIs('pidana-reports.*') || request()->routeIs('tun-reports.*') || request()->routeIs('konsultasi-hukum-reports.*') || request()->routeIs('investigasi-kasus-reports.*') ? 'var(--brand-1)' : '#64748b'); ?>;"></i>
                </div>
                Laporan BPHN/KANWIL
                <i class="fa-solid fa-chevron-right ms-auto" style="font-size:.6rem;transition:var(--trans);" id="bphnMenuArrow"></i>
            </button>
            <div class="submenu-wrap" id="bphnMenu" style="display:<?php echo e(request()->routeIs('drafting-reports.*') || request()->routeIs('mediasi-reports.*') || request()->routeIs('negosiasi-reports.*') || request()->routeIs('pemberdayaan-masyarakat.*') || request()->routeIs('reimbursement-reports.create-pemberdayaan') || request()->routeIs('pendampingan-reports.*') || request()->routeIs('penelitian-hukum-reports.*') || request()->routeIs('penyuluhan-hukum-reports.*') || request()->routeIs('perdata-reports.*') || request()->routeIs('pidana-reports.*') || request()->routeIs('tun-reports.*') || request()->routeIs('konsultasi-hukum-reports.*') || request()->routeIs('investigasi-kasus-reports.*') ? 'block' : 'none'); ?>;">
                <div class="submenu-inner">
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('drafting-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('drafting-reports.*') ? 'active' : ''); ?>">
                            <i class="fa-regular fa-file-lines me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Drafting Dokumen Hukum
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('mediasi-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('mediasi-reports.*') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-handshake me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Laporan Mediasi
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('pemberdayaan-masyarakat.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('pemberdayaan-masyarakat.*') || request()->routeIs('reimbursement-reports.create-pemberdayaan') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-person-chalkboard me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Pemberdayaan Masyarakat
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('negosiasi-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('negosiasi-reports.*') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-file-signature me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Laporan Negosiasi
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('pendampingan-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('pendampingan-reports.*') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-scale-balanced me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Pendampingan Diluar Pengadilan
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('penelitian-hukum-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('penelitian-hukum-reports.*') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-microscope me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Penelitian Hukum
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('penyuluhan-hukum-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('penyuluhan-hukum-reports.*') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-chalkboard-user me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Penyuluhan Hukum
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('perdata-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('perdata-reports.*') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-gavel me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Perdata
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('pidana-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('pidana-reports.*') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-handcuffs me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Pidana
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('tun-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('tun-reports.*') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-landmark me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            TUN
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('konsultasi-hukum-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('konsultasi-hukum-reports.*') ? 'active' : ''); ?>">
                            <i class="fa-solid fa-comments me-2" style="width:14px;color:#6366f1;font-size:.75rem;"></i>
                            Konsultasi Hukum
                        </a>
                    </div>
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('investigasi-kasus-reports.index')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('investigasi-kasus-reports.*') ? 'active' : ''); ?>">
        ...
        <div class="nav-item-custom">
            <a href="<?php echo e(route('users.index')); ?>"
               class="nav-link-custom <?php echo e(request()->routeIs('users.*') ? 'active' : ''); ?>">
                <div class="nav-icon" style="background:<?php echo e(request()->routeIs('users.*') ? 'rgba(14,165,233,.15)' : 'rgba(100,116,139,.08)'); ?>;">
                    <i class="fa-solid fa-users" style="color:<?php echo e(request()->routeIs('users.*') ? '#0ea5e9' : '#64748b'); ?>;"></i>
                </div>
                Manajemen Users
            </a>
        </div>
        ...
        <div class="nav-item-custom">
            <a href="<?php echo e(route('lawyers.index')); ?>"
               class="nav-link-custom <?php echo e(request()->routeIs('lawyers.*') ? 'active' : ''); ?>">
        ...
        <div class="nav-item-custom">
            <a href="<?php echo e(route('keahlian-spesialisasi.index')); ?>"
               class="nav-link-custom <?php echo e(request()->routeIs('keahlian-spesialisasi.*') ? 'active' : ''); ?>">
                <div class="nav-icon" style="background:<?php echo e(request()->routeIs('keahlian-spesialisasi.*') ? 'rgba(99,102,241,.15)' : 'rgba(100,116,139,.08)'); ?>;">
                    <i class="fa-solid fa-scale-balanced" style="color:<?php echo e(request()->routeIs('keahlian-spesialisasi.*') ? '#6366f1' : '#64748b'); ?>;"></i>
                </div>
...
<div class="main-content">
    ...
    <div class="topbar">
        <?php if(isset($header)): ?>
        <div>
            <div class="topbar-title"><?php echo e($header); ?></div>
            <div class="topbar-sub"><?php echo e(now()->isoFormat('dddd, D MMMM YYYY')); ?></div>
        </div>
        <?php else: ?>
    ...
    <footer class="text-center py-4" style="font-size:.72rem;color:#94a3b8;border-top:1px solid rgba(0,0,0,.05);">
        &copy; <?php echo e(date('Y')); ?> LBH UNSUB
    </footer>
</div>
