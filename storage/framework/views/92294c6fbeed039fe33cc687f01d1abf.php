...
<aside class="sidebar" id="sidebar">
    ...
    <div style="flex:1;padding-top:8px;">
        ...
        <div class="nav-item-custom">
            <button class="nav-link-custom <?php echo e(request()->routeIs('drafting-reports.*') || request()->routeIs('mediasi-reports.*') || request()->routeIs('negosiasi-reports.*') || request()->routeIs('reimbursement-reports.create-pemberdayaan') ? 'active' : ''); ?>"
            ...
            <div class="submenu-wrap" id="bphnMenu" style="display:<?php echo e(request()->routeIs('drafting-reports.*') || request()->routeIs('mediasi-reports.*') || request()->routeIs('negosiasi-reports.*') || request()->routeIs('reimbursement-reports.create-pemberdayaan') ? 'block' : 'none'); ?>;">
                <div class="submenu-inner">
                    ...
                    <div class="nav-item-custom" style="margin:0;">
                        <a href="<?php echo e(route('reimbursement-reports.create-pemberdayaan')); ?>"
                           class="nav-link-custom <?php echo e(request()->routeIs('reimbursement-reports.create-pemberdayaan') ? 'active' : ''); ?>">
