...
<body style="font-family: Arial, sans-serif; color: #1f2937; line-height: 1.6; margin: 0; padding: 24px; background: #f8fafc;">
    <div style="max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden;">
        ...
        <div style="background: <?php echo e($headerColor); ?>; padding: 20px 24px;">
            ...
            <p style="margin: 4px 0 0; font-size: 13px; color: rgba(255,255,255,.8);">No. Registrasi: <?php echo e($permohonanNonLitigasi->no_registrasi); ?></p>
        </div>

        <div style="padding: 24px;">
            <p>Yth. <?php echo e($permohonanNonLitigasi->nama_pemohon); ?>,</p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
                ...
                <tr>
                    ...
                    <td style="padding: 8px; border-bottom: 1px solid #e5e7eb;"><?php echo e($permohonanNonLitigasi->assignedLawyer->name); ?></td>
                </tr>
                <?php endif; ?>
                ...
                <tr>
                    ...
                    <td style="padding: 8px; border-bottom: 1px solid #e5e7eb;"><?php echo e($permohonanNonLitigasi->assignedParalegal->name); ?></td>
                </tr>
                <?php endif; ?>
            </table>
...
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\emails\permohonan-non-litigasi-status.blade.php ENDPATH**/ ?>