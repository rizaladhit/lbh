...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Master Data Paralegal <?php $__env->endSlot(); ?>
    ...
    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div style="font-size:.72rem;color:#94a3b8;">Total <?php echo e($paralegals->total()); ?> paralegal terdaftar</div>
                </div>
            </div>
            <a href="<?php echo e(route('paralegals.create')); ?>" class="btn-cta">
        ...
        <div class="table-responsive">
            <table class="data-table table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $paralegals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paralegal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td style="padding-left:24px;">
                            <div class="d-flex align-items-center gap-3">
                                <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($paralegal->name)); ?>&background=10b981&color=fff&size=40"
                                     style="width:38px;height:38px;border-radius:10px;" alt="<?php echo e($paralegal->name); ?>">
                                <div>
                                    <div style="font-weight:600;font-size:.88rem;" class="text-body"><?php echo e($paralegal->name); ?></div>
                                    <div style="font-size:.72rem;color:#94a3b8;"><?php echo e($paralegal->phone); ?></div>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div style="font-size:.82rem;font-weight:500;" class="text-body"><?php echo e($paralegal->email); ?></div>
                            <div style="font-size:.72rem;color:#94a3b8;"><?php echo e($paralegal->created_at->diffForHumans()); ?></div>
                        </td>
                        <td><span class="role-badge"><?php echo e($paralegal->no_identitas); ?></span></td>
                        <td><?php echo e($paralegal->specialization); ?></td>
                        <td>
                            <span class="badge <?php echo e($paralegal->getStatusBadgeColor()); ?>">
                                <?php echo e($paralegal->getStatusLabel()); ?>

                            </span>
                        </td>
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                <a href="<?php echo e(route('paralegals.show', $paralegal)); ?>" class="action-btn" style="color:#10b981;" title="Detail">
                                    <i class="fa-solid fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('paralegals.edit', $paralegal)); ?>" class="action-btn" style="color:#f59e0b;" title="Edit">
                                    <i class="fa-solid fa-pen"></i>
                                </a>
                                <button onclick="confirmDelete('<?php echo e(route('paralegals.destroy', $paralegal)); ?>')" class="action-btn" style="color:#ef4444;" title="Hapus">
        ...
        <div style="padding:16px 24px;border-top:1px solid rgba(0,0,0,.05);display:flex;justify-content:space-between;align-items:center;">
            <span style="font-size:.75rem;color:#94a3b8;">Menampilkan hal. <?php echo e($paralegals->currentPage()); ?> dari <?php echo e($paralegals->lastPage()); ?></span>
            <?php echo e($paralegals->links('pagination::bootstrap-5')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\paralegals\index.blade.php ENDPATH**/ ?>