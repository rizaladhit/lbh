...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Laporan Investigasi Kasus <?php $__env->endSlot(); ?>
    ...
    <style>
        ...
        .badge-keg { background: rgba(245,158,11,.12); color: #d97706; padding: 4px 10px; border-radius: 99px; font-size: .7rem; font-weight: 700; display: inline-block; }
    </style>

    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                <div style="width:36px;height:36px;border-radius:10px;background:rgba(245,158,11,.1);display:flex;align-items:center;justify-content:center;">
            ...
            <a href="<?php echo e(route('investigasi-kasus-reports.create')); ?>" class="btn-cta">
    ...
    <script>
        function confirmDelete(action){
            if(!confirm('Hapus laporan Investigasi Kasus ini secara permanen?')) return;
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views/investigasi_kasus_reports/index.blade.php ENDPATH**/ ?>