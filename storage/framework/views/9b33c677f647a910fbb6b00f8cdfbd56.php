...
<head>
    ...
    <title>Cetak Checklist Berkas - <?php echo e($negosiasiReport->nama_negosiator); ?></title>
...
<body>
    ...
    <div class="print-actions">
        ...
        <a href="<?php echo e(route('negosiasi-reports.show', $negosiasiReport)); ?>" class="btn btn-secondary btn-sm fw-medium">
            Kembali
        </a>
    </div>
        ...
        <div class="pv-group pv-g2">
            ...
            <div class="pv-row">
                ...
                <span class="pv-val" style="display:flex;justify-content:space-between;">
                    <span><?php echo e($negosiasiReport->penerima_bantuan); ?></span>
                    <strong>L/P : <?php echo e($negosiasiReport->jk_penerima); ?></strong>
                </span>
            </div>
            <div class="pv-row">
