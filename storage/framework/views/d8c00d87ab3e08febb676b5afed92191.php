...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Edit Keahlian/Spesialisasi <?php $__env->endSlot(); ?>
        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('keahlian-spesialisasi.update', $keahlianSpesialisasi)); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                name="nama" value="<?php echo e(old('nama', $keahlianSpesialisasi->nama)); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                            <a href="<?php echo e(route('keahlian-spesialisasi.index')); ?>" class="btn btn-light fw-medium">Batalkan</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lbh\resources\views\keahlian-spesialisasi\edit.blade.php ENDPATH**/ ?>