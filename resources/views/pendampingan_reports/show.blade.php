    ...
    <div class="d-print-none row justify-content-center">
        <div class="col-lg-10">
                    ...
                    <table class="table table-bordered border-secondary align-middle mb-4" style="font-size:.88rem;">
                        ...
                        <tbody>
                            ...
                            @if($key === 'item3')
                                ...
                                <tr>
                                    <td></td>
                                    <td class="ps-4 text-muted fw-medium">{{ $sl }}</td>
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                ...
                <a href="{{ route('pendampingan-reports.edit', $pendampinganReport) }}" class="btn btn-warning px-4 fw-bold shadow-sm">
                    <i class="fa-solid fa-pen-to-square me-1"></i> Edit
                </a>
                <a href="{{ route('pendampingan-reports.print', $pendampinganReport) }}" class="btn btn-success px-4 fw-bold shadow-sm">
