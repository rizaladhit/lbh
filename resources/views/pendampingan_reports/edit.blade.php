<x-app-layout>
    <x-slot name="header">Edit Laporan Pendampingan Diluar Pengadilan</x-slot>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('pendampingan-reports.update', $pendampinganReport) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="obh" class="form-control border-secondary border-opacity-50" value="{{ old('obh', $pendampinganReport->obh) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="alamat" class="form-control border-secondary border-opacity-50" value="{{ old('alamat', $pendampinganReport->alamat) }}" required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="provinsi" class="form-control border-secondary border-opacity-50" value="{{ old('provinsi', $pendampinganReport->provinsi) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="kasus" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('kasus', $pendampinganReport->kasus) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 ps-3">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <input type="date" name="tgl_pendampingan_{{ $num }}" class="form-control border-secondary border-opacity-50" style="max-width:200px;" value="{{ old('tgl_pendampingan_'.$num, $pendampinganReport->{'tgl_pendampingan_'.$num}) }}">
                                </div>
                                @endforeach
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="penerima_bantuan" class="form-control mx-2 border-secondary border-opacity-50" value="{{ old('penerima_bantuan', $pendampinganReport->penerima_bantuan) }}" required>
                                <select name="jk_penerima" class="form-select w-auto border-secondary border-opacity-50" required>
                                    <option value="">L/P</option>
                                    <option value="L" {{ old('jk_penerima', $pendampinganReport->jk_penerima) == 'L' ? 'selected' : '' }}>L</option>
                                    <option value="P" {{ old('jk_penerima', $pendampinganReport->jk_penerima) == 'P' ? 'selected' : '' }}>P</option>
                                </select>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="{{ route('pendampingan-reports.show', $pendampinganReport) }}" class="btn btn-light border me-2 fw-medium">Batal</a>
