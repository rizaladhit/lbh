    ...
    <div class="d-print-none row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                ...
                <a href="{{ route('penelitian-hukum-reports.edit', $penelitianHukumReport) }}" class="btn btn-warning px-4 fw-bold shadow-sm">
                    <i class="fa-solid fa-pen-to-square me-1"></i> Edit
                </a>
                <a href="{{ route('penelitian-hukum-reports.print', $penelitianHukumReport) }}" class="btn btn-success px-4 fw-bold shadow-sm">
