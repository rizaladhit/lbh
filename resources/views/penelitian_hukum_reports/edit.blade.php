<x-app-layout>
    <x-slot name="header">Edit Laporan Penelitian Hukum</x-slot>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('penelitian-hukum-reports.update', $penelitianHukumReport) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="obh" class="form-control border-secondary border-opacity-50" value="{{ old('obh', $penelitianHukumReport->obh) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="alamat" class="form-control border-secondary border-opacity-50" value="{{ old('alamat', $penelitianHukumReport->alamat) }}" required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="provinsi" class="form-control border-secondary border-opacity-50" value="{{ old('provinsi', $penelitianHukumReport->provinsi) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="date" name="tgl_pelaksanaan" class="form-control ms-2 border-secondary border-opacity-50" style="max-width:220px;" value="{{ old('tgl_pelaksanaan', $penelitianHukumReport->tgl_pelaksanaan) }}">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="judul_penelitian" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('judul_penelitian', $penelitianHukumReport->judul_penelitian) }}" required>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="{{ route('penelitian-hukum-reports.show', $penelitianHukumReport) }}" class="btn btn-light border me-2 fw-medium">Batal</a>
