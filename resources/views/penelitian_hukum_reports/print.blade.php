...
<head>
    ...
    <title>Cetak Checklist Berkas - {{ $penelitianHukumReport->obh }}</title>
...
<body>
    ...
    <div class="print-actions">
        ...
        <a href="{{ route('penelitian-hukum-reports.show', $penelitianHukumReport) }}" class="btn btn-secondary btn-sm fw-medium">
            Kembali
        </a>
    </div>
