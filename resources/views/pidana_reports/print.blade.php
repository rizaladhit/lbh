...
<head>
    ...
    <title>Cetak Checklist Berkas - {{ $pidanaReport->obh }}</title>
...
<body>
    ...
    <div class="print-actions">
        ...
        <a href="{{ route('pidana-reports.show', $pidanaReport) }}" class="btn btn-secondary btn-sm fw-medium">
            Kembali
        </a>
    </div>
    ...
    <main class="page">
        ...
        <div class="pv-group pv-g1">
            <div class="pv-row">
                ...
                <span class="pv-val">{{ $pidanaReport->obh }}</span>
            </div>
            <div class="pv-row">
                <span class="pv-label">ALAMAT</span>
                <span class="pv-sep">:</span>
                <span class="pv-val">{{ $pidanaReport->alamat }}</span>
            </div>
            <div class="pv-row">
                <span class="pv-label">PROVINSI</span>
                <span class="pv-sep">:</span>
                <span class="pv-val">{{ $pidanaReport->provinsi }}</span>
            </div>
        </div>
        ...
        <div class="pv-group pv-g2">
            ...
            <div class="pv-row">
                ...
                <span class="pv-sep">:</span>
                <span class="pv-val">{{ $pidanaReport->kasus }}</span>
            </div>
            <div class="pv-row">
                <span class="pv-label">NOMOR PERKARA</span>
                <span class="pv-sep">:</span>
                <span class="pv-val">{{ $pidanaReport->nomor_perkara }}</span>
            </div>
            <div class="pv-row">
