<x-app-layout>
    <x-slot name="header">Edit Laporan Pidana</x-slot>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('pidana-reports.update', $pidanaReport) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="obh" class="form-control border-secondary border-opacity-50" value="{{ old('obh', $pidanaReport->obh) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="alamat" class="form-control border-secondary border-opacity-50" value="{{ old('alamat', $pidanaReport->alamat) }}" required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="provinsi" class="form-control border-secondary border-opacity-50" value="{{ old('provinsi', $pidanaReport->provinsi) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="kasus" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('kasus', $pidanaReport->kasus) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="nomor_perkara" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('nomor_perkara', $pidanaReport->nomor_perkara) }}">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="penerima_bantuan" class="form-control mx-2 border-secondary border-opacity-50" value="{{ old('penerima_bantuan', $pidanaReport->penerima_bantuan) }}">
                                <select name="jk_penerima" class="form-select w-auto border-secondary border-opacity-50">
                                    <option value="">L/P</option>
                                    <option value="L" {{ old('jk_penerima', $pidanaReport->jk_penerima) == 'L' ? 'selected' : '' }}>L</option>
                                    <option value="P" {{ old('jk_penerima', $pidanaReport->jk_penerima) == 'P' ? 'selected' : '' }}>P</option>
                                </select>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="{{ route('pidana-reports.show', $pidanaReport) }}" class="btn btn-light border me-2 fw-medium">Batal</a>
