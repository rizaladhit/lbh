<x-app-layout>
    <x-slot name="header">Laporan Pidana</x-slot>
    ...
    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 class="mb-0 fw-bold text-body">Daftar Laporan Pidana</h6>
                    <div style="font-size:.72rem;color:#94a3b8;">Total {{ $reports->total() }} laporan terdata</div>
                </div>
            </div>
            <a href="{{ route('pidana-reports.create') }}" class="btn-cta">
                    ...
                    <tr>
                        ...
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                <a href="{{ route('pidana-reports.show', $report) }}" class="action-btn" style="color:#6366f1;" title="Detail Laporan">
                                    <i class="fa-solid fa-eye"></i>
                                </a>
                                <button onclick="confirmDelete('{{ route('pidana-reports.destroy', $report) }}')" class="action-btn" style="color:#ef4444;" title="Hapus Laporan">
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <h6 class="fw-bold text-body mb-1">Belum Ada Laporan Pidana</h6>
                                <p class="text-muted mb-4" style="font-size:.85rem;">Mulai dengan membuat laporan Pidana yang pertama.</p>
                                <a href="{{ route('pidana-reports.create') }}" class="btn-cta" style="margin:auto;width:fit-content;">
