<x-app-layout>
    <x-slot name="header">Laporan Penyuluhan Hukum</x-slot>
    ...
    <div class="panel">
        <div class="panel-head">
            ...
            <a href="{{ route('penyuluhan-hukum-reports.create') }}" class="btn-cta">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding-left:24px;">
                            <div style="font-size:.85rem;font-weight:600;" class="text-body">{{ Str::limit($report->materi ?? '-', 36) }}</div>
                        ...
                        <td>
                            <div style="font-size:.85rem;font-weight:600;" class="text-body">{{ $report->narasumber ?? '-' }}</div>
                        </td>
                        <td>
                        ...
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                <a href="{{ route('penyuluhan-hukum-reports.show', $report) }}" class="action-btn" style="color:#6366f1;" title="Detail Laporan">
                                    <i class="fa-solid fa-eye"></i>
                                </a>
                                <a href="{{ route('penyuluhan-hukum-reports.edit', $report) }}" class="action-btn" style="color:#f59e0b;" title="Edit Laporan">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <button onclick="confirmDelete('{{ route('penyuluhan-hukum-reports.destroy', $report) }}')" class="action-btn" style="color:#ef4444;" title="Hapus Laporan">
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <a href="{{ route('penyuluhan-hukum-reports.create') }}" class="btn-cta" style="margin:auto;width:fit-content;">
