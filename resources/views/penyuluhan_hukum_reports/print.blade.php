...
<head>
    ...
    <title>Cetak Checklist Berkas - {{ $penyuluhanHukumReport->obh }}</title>
...
<body>
    ...
    <div class="print-actions">
        ...
        <a href="{{ route('penyuluhan-hukum-reports.show', $penyuluhanHukumReport) }}" class="btn btn-secondary btn-sm fw-medium">
            Kembali
        </a>
    </div>
