        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-transparent py-3 d-flex justify-content-between">
                    ...
                    <span class="badge bg-light text-body border">#{{ $category->id }}</span>
                </div>
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('categories.update', $category) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="name" class="form-control" type="text" name="name" value="{{ old('name', $category->name) }}" required autofocus />
