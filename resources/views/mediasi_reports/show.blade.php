        ...
        <div class="col-lg-10">
            <div class="card shadow-md border-0 mb-4 p-4 p-md-5" id="printableArea">
                ...
                <div class="card-header bg-transparent border-0 mb-4 pb-0 text-center">
                    <h5 class="fw-bold text-uppercase d-inline-block text-decoration-underline" style="text-underline-offset: 4px;">CHECK LIST BERKAS LAPORAN MEDIASI</h5>
                </div>
                ...
                <div class="card-body p-0" style="font-size: 0.95rem;">
                    ...
                    <div class="d-flex mb-1">
                        ...
                        <div class="w-100">: {{ $mediasiReport->penerima_bantuan }} <span class="float-end pe-5"><strong>L/P:</strong> {{ $mediasiReport->jk_penerima }}</span></div>
                    </div>
                    <div class="d-flex mb-4">
                    ...
                    <table class="table table-bordered border-secondary align-middle mb-4">
                        ...
                        <tbody>
                            @php
                                $checklist = $mediasiReport->checklist_data ?? [];
                            ...
                            @foreach($checklist as $index => $item)
                                <tr>
                                    ...
                                    <td class="text-center"><span class="checklist-square">{!! $get_check($item, 'obh') !!}</span></td>
                                    <td class="text-center"><span class="checklist-square">{!! $get_check($item, 'kanwil') !!}</span></td>
                                    <td class="text-center"><span class="checklist-square">{!! $get_check($item, 'bphn') !!}</span></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
