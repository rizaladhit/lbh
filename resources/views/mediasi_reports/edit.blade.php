<x-app-layout>
    <x-slot name="header">Edit Laporan Mediasi</x-slot>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('mediasi-reports.update', $mediasiReport) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="obh" class="form-control border-secondary border-opacity-50" value="{{ old('obh', $mediasiReport->obh) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="alamat" class="form-control border-secondary border-opacity-50" value="{{ old('alamat', $mediasiReport->alamat) }}" required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="provinsi" class="form-control border-secondary border-opacity-50" value="{{ old('provinsi', $mediasiReport->provinsi) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="date" name="tgl_pelaksanaan" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('tgl_pelaksanaan', $mediasiReport->tgl_pelaksanaan) }}" style="max-width: 220px;" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="kasus" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('kasus', $mediasiReport->kasus) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="penerima_bantuan" class="form-control mx-2 border-secondary border-opacity-50" value="{{ old('penerima_bantuan', $mediasiReport->penerima_bantuan) }}" required>
                                <select name="jk_penerima" class="form-select w-auto border-secondary border-opacity-50" required>
                                    <option value="" {{ old('jk_penerima', $mediasiReport->jk_penerima) == '' ? 'selected' : '' }}>L/P</option>
                                    <option value="L" {{ old('jk_penerima', $mediasiReport->jk_penerima) == 'L' ? 'selected' : '' }}>L</option>
                                    <option value="P" {{ old('jk_penerima', $mediasiReport->jk_penerima) == 'P' ? 'selected' : '' }}>P</option>
                                </select>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="nama_mediator" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('nama_mediator', $mediasiReport->nama_mediator) }}" required>
                                @error('nama_mediator')<div class="text-danger small ms-3">{{ $message }}</div>@enderror
                            </div>
                        </div>

                        @php
                            $cl = old('checklist_data', $mediasiReport->checklist_data ?? []);
                        @endphp
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="{{ route('mediasi-reports.show', $mediasiReport) }}" class="btn btn-light border me-2 fw-medium">Batal</a>
