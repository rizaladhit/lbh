...
<head>
    <meta charset="utf-8">
    <title>Checklist Investigasi Kasus - {{ $investigasiKasusReport->obh }}</title>
    <style>
        @page {
            size: A4;
...
<body>
    ...
    <table class="info">
        <tr>
            <td class="lbl">OBH</td>
            <td class="sep">:</td>
            <td class="val">{{ $investigasiKasusReport->obh }}</td>
        </tr>
        <tr>
            <td class="lbl">ALAMAT</td>
            <td class="sep">:</td>
            <td class="val">{{ $investigasiKasusReport->alamat }}</td>
        </tr>
        <tr>
            <td class="lbl">PROVINSI</td>
            <td class="sep">:</td>
            <td class="val">{{ $investigasiKasusReport->provinsi }}</td>
        </tr>
    </table>
        ...
        <div class="section-block {{ ($i === 2 || $i === 4) ? 'page-break' : '' }}">
            <table class="info">
                ...
                <tr>
                    ...
                    <td class="sep">:</td>
                    <td class="val">{{ $sec['jenis_investigasi'] ?? '' }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="sep">:</td>
                    <td class="val">{{ $sec['nama_investigator'] ?? '' }}</td>
                </tr>
            </table>
            ...
            <table class="checklist">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="chk-col">{{ $chk('item1', 'obh') }}</td>
                        <td class="chk-col">{{ $chk('item1', 'kanwil') }}</td>
                        <td class="chk-col">{{ $chk('item1', 'bphn') }}</td>
                    </tr>
                    <tr>
                        <td class="no-col">2.</td>
                        <td>Formulir investigasi kasus yang sudah diisi lengkap</td>
                        <td class="chk-col">{{ $chk('item2', 'obh') }}</td>
                        <td class="chk-col">{{ $chk('item2', 'kanwil') }}</td>
                        <td class="chk-col">{{ $chk('item2', 'bphn') }}</td>
                    </tr>
                    <tr>
                        <td class="no-col">3.</td>
                        <td>Laporan hasil investigasi kasus</td>
                        <td class="chk-col">{{ $chk('item3', 'obh') }}</td>
                        <td class="chk-col">{{ $chk('item3', 'kanwil') }}</td>
                        <td class="chk-col">{{ $chk('item3', 'bphn') }}</td>
                    </tr>
                    <tr>
                    ...
                    @foreach ($sub_items[$i] as $sk => $slabel)
                        <tr>
                            <td></td>
                            <td class="sub-label">- {{ $slabel }}</td>
                            <td class="chk-col">{{ $chk($sk, 'obh') }}</td>
                            <td class="chk-col">{{ $chk($sk, 'kanwil') }}</td>
                            <td class="chk-col">{{ $chk($sk, 'bphn') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
