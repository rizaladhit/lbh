        ...
        <div class="col-lg-10">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-transparent py-3 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-light text-body border">{{ $report->report_id }}</span>
                </div>
                    ...
                    <form method="POST" action="{{ route('reports.update', $report) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="date" class="form-control border-start border-primary border-4" type="date" name="date" value="{{ old('date', $report->date) }}" required />
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="client_name" class="form-control" type="text" name="client_name" value="{{ old('client_name', $report->client_name) }}" required />
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="client_contact" class="form-control" type="text" name="client_contact" value="{{ old('client_contact', $report->client_contact) }}" required />
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="case_title" class="form-control" type="text" name="case_title" value="{{ old('case_title', $report->case_title) }}" required />
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="description" name="description" rows="4" class="form-control" required>{{ old('description', $report->description) }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="status" name="status" class="form-select" required>
                                    ...
                                    <option value="In Progress" {{ old('status', $report->status) == 'In Progress' ? 'selected' : '' }}>In Progress</option>
                            ...
                            <div class="col-md-12 bg-light p-3 rounded border">
                                ...
                                @if($report->attachment_path)
                                    <div class="mb-2 small text-muted">
                                        Current file: <a href="{{ asset('storage/'.$report->attachment_path) }}" target="_blank" class="text-primary text-decoration-none fw-medium"><i class="fa-solid fa-link"></i> View Document</a>
                                    </div>
                                @endif
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="notes" name="notes" rows="2" class="form-control" placeholder="Optional internal notes...">{{ old('notes', $report->notes) }}</textarea>
