                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding-right:24px;">
                            <div class="d-flex align-items-center gap-2">
                                <a href="{{ route($isTypePengadilan ? 'laporan-ph.pengadilan.edit' : 'laporan-ph.lapas.edit', $r) }}" 
                                ...
                                <form action="{{ route($isTypePengadilan ? 'laporan-ph.pengadilan.destroy' : 'laporan-ph.lapas.destroy', $r) }}" 
                                      method="POST" 
                                      class="d-inline"
