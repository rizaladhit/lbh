<x-app-layout>
    <x-slot name="header">Edit Data Advocate</x-slot>
                ...
                <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" 
                                name="name" value="{{ old('name', $lawyer->name) }}" placeholder="Pilih akun Advocate terlebih dahulu" required autofocus>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="specialization" class="form-select @error('specialization') is-invalid @enderror"
                                ...
                                @foreach($keahlians as $keahlian)
                                    <option value="{{ $keahlian->nama }}" {{ old('specialization', $lawyer->specialization) === $keahlian->nama ? 'selected' : '' }}>
                                        {{ $keahlian->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="notes" class="form-control @error('notes') is-invalid @enderror" 
                                name="notes" rows="2" placeholder="Catatan tambahan tentang advocate">{{ old('notes', $lawyer->notes) }}</textarea>
