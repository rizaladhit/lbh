                ...
                <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="no_kta_lbh" type="text" class="form-control @error('no_kta_lbh') is-invalid @enderror"
                                name="no_kta_lbh" value="{{ old('no_kta_lbh') }}" placeholder="Contoh: KTA/LBH/001/2024">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="address" class="form-control @error('address') is-invalid @enderror" 
                                name="address" rows="3" placeholder="Masukkan alamat kantor atau alamat pribadi">{{ old('address') }}</textarea>
