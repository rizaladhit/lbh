<x-app-layout>
    <x-slot name="header">Buat Laporan TUN</x-slot>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('tun-reports.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="{{ route('tun-reports.index') }}" class="btn btn-light border me-2 fw-medium">Batal</a>
