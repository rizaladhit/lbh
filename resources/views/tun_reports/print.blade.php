...
<head>
    ...
    <title>Cetak Checklist Berkas - {{ $tunReport->obh }}</title>
...
<body>
    ...
    <div class="print-actions">
        ...
        <a href="{{ route('tun-reports.show', $tunReport) }}" class="btn btn-secondary btn-sm fw-medium">
            Kembali
        </a>
    </div>
    ...
    <main class="page">
        ...
        <div class="pv-group pv-g1">
            <div class="pv-row">
                ...
                <span class="pv-val">{{ $tunReport->obh }}</span>
            </div>
            <div class="pv-row">
                <span class="pv-label">ALAMAT</span>
                <span class="pv-sep">:</span>
                <span class="pv-val">{{ $tunReport->alamat }}</span>
            </div>
            <div class="pv-row">
                <span class="pv-label">PROVINSI</span>
                <span class="pv-sep">:</span>
                <span class="pv-val">{{ $tunReport->provinsi }}</span>
            </div>
        </div>
        ...
        <div class="pv-group pv-g2">
            ...
            <div class="pv-row">
                ...
                <span class="pv-sep">:</span>
                <span class="pv-val">{{ $tunReport->kasus }}</span>
            </div>
            <div class="pv-row">
                <span class="pv-label">NOMOR PERKARA</span>
                <span class="pv-sep">:</span>
                <span class="pv-val">{{ $tunReport->nomor_perkara }}</span>
            </div>
            <div class="pv-row">
