<x-app-layout>
    <x-slot name="header">Master Keahlian/Spesialisasi</x-slot>
        ...
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div style="font-size:.72rem;color:#94a3b8;">Total {{ $keahlians->count() }} keahlian terdaftar</div>
                </div>
            </div>
            <a href="{{ route('keahlian-spesialisasi.create') }}" class="btn-cta">
            ...
            <table class="data-table table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="font-size:.85rem;font-weight:600;" class="text-body">{{ $keahlian->nama }}</div>
                        </td>
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                <a href="{{ route('keahlian-spesialisasi.edit', $keahlian) }}" class="action-btn" style="color:#f59e0b;" title="Edit">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <form action="{{ route('keahlian-spesialisasi.destroy', $keahlian) }}" method="POST" style="display:inline;"
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="empty-state">
                                ...
                                <a href="{{ route('keahlian-spesialisasi.create') }}" class="btn-cta" style="margin:auto;width:fit-content;">
