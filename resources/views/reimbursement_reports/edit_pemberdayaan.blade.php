<x-app-layout>
    <x-slot name="header">Edit Laporan Pemberdayaan Masyarakat</x-slot>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form method="POST" action="{{ route('pemberdayaan-masyarakat.update', $reimbursementReport) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="date" name="tgl_pelaksanaan" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('tgl_pelaksanaan', optional($reimbursementReport->tgl_pelaksanaan)->format('Y-m-d')) }}" style="max-width: 220px;" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="penerima_bantuan" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('penerima_bantuan', $reimbursementReport->penerima_bantuan) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="tempat_pelaksanaan" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('tempat_pelaksanaan', $reimbursementReport->tempat_pelaksanaan) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="materi" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('materi', $reimbursementReport->materi) }}" required>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="narasumber" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('narasumber', $reimbursementReport->narasumber) }}" required>
                                ...
                                <tbody>
                                    ...
                                    @foreach($items as $key => $label)
                                        <tr>
                                            ...
                                            @if($key !== 'item8')
                                                <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[{{ $key }}][obh]" value="1" {{ $isChecked($key, 'obh') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[{{ $key }}][kanwil]" value="1" {{ $isChecked($key, 'kanwil') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[{{ $key }}][bphn]" value="1" {{ $isChecked($key, 'bphn') ? 'checked' : '' }}></td>
                                            @else
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                        ...
                                        @if($key === 'item8')
                                            @foreach($subitems as $subkey => $sublabel)
                                                <tr>
                                                    ...
                                                    <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[{{ $subkey }}][obh]" value="1" {{ $isChecked($subkey, 'obh') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[{{ $subkey }}][kanwil]" value="1" {{ $isChecked($subkey, 'kanwil') ? 'checked' : '' }}></td>
                                                    <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist_data[{{ $subkey }}][bphn]" value="1" {{ $isChecked($subkey, 'bphn') ? 'checked' : '' }}></td>
                                                </tr>
                                            @endforeach
                                        @endif
                                    @endforeach
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="{{ route('pemberdayaan-masyarakat.show', $reimbursementReport) }}" class="btn btn-light border me-2 fw-medium">Batal</a>
