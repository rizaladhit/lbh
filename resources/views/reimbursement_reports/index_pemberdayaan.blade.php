    ...
    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 class="mb-0 fw-bold text-body">Daftar Laporan Pemberdayaan Masyarakat</h6>
        ...
        <div class="table-responsive">
            <table class="data-table table">
                <thead>
                    <tr>
                        <th style="padding-left:24px;">OBH / Wilayah</th>
                        <th>Materi</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding-left:24px;">
                            <div style="font-size:.85rem;font-weight:700;" class="text-body">{{ $report->obh }}</div>
                            <div style="font-size:.7rem;color:#94a3b8;margin-top:2px;">{{ $report->provinsi }}</div>
                        </td>
                        <td>
                            <div style="font-size:.82rem;font-weight:500;" class="text-body">{{ $report->materi ?? '-' }}</div>
                        </td>
                        <td>
                            <div style="font-size:.82rem;" class="text-body">{{ $report->tempat_pelaksanaan ?? '-' }}</div>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <h6 class="fw-bold text-body mb-1">Belum Ada Laporan Pemberdayaan Masyarakat</h6>
