<x-app-layout>
    <x-slot name="header">Buat Laporan Konsultasi Hukum</x-slot>
        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('konsultasi-hukum-reports.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="border rounded p-4 mb-4" style="background: var(--bs-secondary-bg);">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-7 d-flex align-items-center">
                                    : <input type="text" name="sections[{{ $i }}][materi]" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('sections.'.$i.'.materi') }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7 d-flex align-items-center">
                                    : <input type="text" name="sections[{{ $i }}][nama_konsultan]" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('sections.'.$i.'.nama_konsultan') }}">
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="sections[{{ $i }}][checklist][{{ $key }}][obh]" value="1" {{ old('sections.'.$i.'.checklist.'.$key.'.obh') ? 'checked' : '' }}></td>
                                            <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="sections[{{ $i }}][checklist][{{ $key }}][kanwil]" value="1" {{ old('sections.'.$i.'.checklist.'.$key.'.kanwil') ? 'checked' : '' }}></td>
                                            <td class="text-center"><input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="sections[{{ $i }}][checklist][{{ $key }}][bphn]" value="1" {{ old('sections.'.$i.'.checklist.'.$key.'.bphn') ? 'checked' : '' }}></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="{{ route('konsultasi-hukum-reports.index') }}" class="btn btn-light border me-2 fw-medium">Batal</a>
