<x-app-layout>
    <x-slot name="header">Laporan Konsultasi Hukum</x-slot>
    ...
    <div class="panel">
        <div class="panel-head">
            ...
            <a href="{{ route('konsultasi-hukum-reports.create') }}" class="btn-cta">
        ...
        <div class="table-responsive">
            <table class="data-table table">
                ...
                <tbody>
                    ...
                    @php $secs = $report->sections ?? []; @endphp
                    <tr>
                        ...
                        <td>
                            <div style="font-size:.82rem;" class="text-body">{{ Str::limit($secs[0]['materi'] ?? '-', 30) }}</div>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <a href="{{ route('konsultasi-hukum-reports.create') }}" class="btn-cta" style="margin:auto;width:fit-content;">
