        ...
        <div class="col-lg-11">
            <div class="card shadow-md border-0 mb-4 p-4 p-md-5">
                ...
                <div class="card-body p-0" style="font-size:0.95rem;">
                    <div class="d-flex mb-1"><div class="fw-bold form-preview-label">OBH</div><div>: {{ $konsultasiHukumReport->obh }}</div></div>
                    <div class="d-flex mb-1"><div class="fw-bold form-preview-label">ALAMAT</div><div>: {{ $konsultasiHukumReport->alamat }}</div></div>
                    <div class="d-flex mb-3"><div class="fw-bold form-preview-label">PROVINSI</div><div>: {{ $konsultasiHukumReport->provinsi }}</div></div>
                    <div class="d-flex mb-4"><div class="fw-bold form-preview-label">KEGIATAN</div><div class="text-uppercase fw-semibold text-primary">: {{ $konsultasiHukumReport->kegiatan }}</div></div>
                    ...
                    <div class="border rounded p-3 mb-4" style="background: var(--bs-secondary-bg);">
                        <h6 class="fw-bold text-uppercase text-primary mb-3">Materi Konsultasi {{ $section_names[$i] }}</h6>
                        <div class="d-flex mb-1"><div class="fw-bold form-preview-label-sm" style="font-size:.88rem;">MATERI KONSULTASI {{ $section_names[$i] }}</div><div>: {{ $sec['materi'] ?? '-' }}</div></div>
                        <div class="d-flex mb-1"><div class="fw-bold form-preview-label-sm" style="font-size:.88rem;">TGL PELAKSANAAN KEGIATAN</div><div>: {{ $sec['tgl_pelaksanaan'] ? \Carbon\Carbon::parse($sec['tgl_pelaksanaan'])->translatedFormat('d F Y') : '-' }}</div></div>
                        ...
                        <div class="d-flex mb-3"><div class="fw-bold form-preview-label-sm" style="font-size:.88rem;">NAMA KONSULTAN</div><div>: {{ $sec['nama_konsultan'] ?? '-' }}</div></div>
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                <a href="{{ route('konsultasi-hukum-reports.index') }}" class="btn btn-secondary px-4 fw-bold shadow-sm">Kembali</a>
