...
<body style="font-family: Arial, sans-serif; color: #1f2937; line-height: 1.6; margin: 0; padding: 24px; background: #f8fafc;">
    <div style="max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden;">
        ...
        <div style="background: {{ $headerColor }}; padding: 20px 24px;">
            ...
            <p style="margin: 4px 0 0; font-size: 13px; color: rgba(255,255,255,.8);">No. Registrasi: {{ $permohonanLitigasi->no_registrasi }}</p>
        </div>

        <div style="padding: 24px;">
            <p>Yth. {{ $permohonanLitigasi->nama }},</p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
                ...
                <tr>
                    ...
                    <td style="padding: 8px; border-bottom: 1px solid #e5e7eb;">{{ $permohonanLitigasi->assignedLawyer->name }}</td>
                </tr>
                @endif
                @if($permohonanLitigasi->assignedParalegal)
                <tr>
                    <td style="padding: 8px; border-bottom: 1px solid #e5e7eb; font-weight: bold;">Paralegal</td>
                    <td style="padding: 8px; border-bottom: 1px solid #e5e7eb;">{{ $permohonanLitigasi->assignedParalegal->name }}</td>
                </tr>
                @endif
            </table>
