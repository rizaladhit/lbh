...
<body style="font-family: Arial, sans-serif; color: #1f2937; line-height: 1.6; margin: 0; padding: 24px; background: #f8fafc;">
    <div style="max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; padding: 24px;">
        ...
        <p>
            Anda ditugaskan sebagai <strong>{{ $recipientRole }}</strong> untuk menangani permohonan non-litigasi berikut:
        </p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
            ...
            <tr>
                ...
                <td style="padding: 8px; border-bottom: 1px solid #e5e7eb;">{{ optional($permohonanNonLitigasi->assigned_at)->format('d/m/Y H:i') }}</td>
            </tr>
        </table>
        ...
        <p style="margin: 24px 0;">
            <a href="{{ route('permohonan-non-litigasi.show', $permohonanNonLitigasi) }}" style="display: inline-block; background: #0ea5e9; color: #ffffff; text-decoration: none; padding: 10px 16px; border-radius: 6px; font-weight: bold;">
                Lihat Permohonan
            </a>
        </p>
