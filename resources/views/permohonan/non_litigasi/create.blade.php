<x-app-layout>
    <x-slot name="header">
        Ajukan Permohonan Bantuan Layanan Non-Litigasi
    </x-slot>
        ...
        <div class="col-xl-8">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 fw-bold text-primary"><i class="fa-solid fa-handshake me-2"></i>Form Bantuan Layanan Non-Litigasi</h6>
                </div>
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('permohonan-non-litigasi.store') }}" enctype="multipart/form-data" id="nonLitigasiForm">
                        @csrf
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="nama_pemohon" class="form-control border-secondary border-opacity-50 @error('nama_pemohon') is-invalid @enderror" value="{{ old('nama_pemohon') }}" required>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <textarea name="alamat_pemohon" class="form-control border-secondary border-opacity-50 @error('alamat_pemohon') is-invalid @enderror" rows="3" required>{{ old('alamat_pemohon') }}</textarea>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="tel" name="telp_hp_pemohon" class="form-control border-secondary border-opacity-50 @error('telp_hp_pemohon') is-invalid @enderror" value="{{ old('telp_hp_pemohon') }}" required>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="nik_pemohon" class="form-control border-secondary border-opacity-50 @error('nik_pemohon') is-invalid @enderror" value="{{ old('nik_pemohon') }}" maxlength="16" required>
                        ...
                        <div class="d-flex justify-content-end pt-3 border-top gap-2">
                            <a href="{{ route('permohonan-non-litigasi.index') }}" class="btn btn-light border fw-medium">Batal</a>
                            <button type="submit" class="btn btn-primary fw-bold px-4 shadow-sm"><i class="fa-solid fa-paper-plane me-1"></i> Kirim Permohonan</button>
                        </div>
                    </form>
                </div>
            </div>
