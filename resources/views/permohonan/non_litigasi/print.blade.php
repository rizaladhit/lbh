...
<body>
    ...
    <div class="print-btn no-print">
        ...
        <a href="{{ route('permohonan-non-litigasi.show', $permohonanNonLitigasi) }}"
    ...
    <div class="page">
        ...
        <table>
            <tbody>
                <tr>
                    <th>Nama Pemohon</th>
                    <td>{{ $permohonanNonLitigasi->nama_pemohon }}</td>
                </tr>
                <tr>
                    <th>NIK Pemohon</th>
                    <td>{{ $permohonanNonLitigasi->nik_pemohon }}</td>
                </tr>
                <tr>
                    <th>Alamat Pemohon</th>
                    <td>{{ $permohonanNonLitigasi->alamat_pemohon }}</td>
                </tr>
                <tr>
                    <th>Telp / HP</th>
                    <td>{{ $permohonanNonLitigasi->telp_hp_pemohon }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <table>
            <tbody>
                <tr>
                    <th>Jenis Layanan</th>
                    <td>{{ $permohonanNonLitigasi->jenis_perkara }}</td>
                </tr>
                <tr>
                    <th>Tgl. Rencana Kunjungan</th>
                    <td>{{ $permohonanNonLitigasi->tgl_rencana_kunjungan->format('d M Y') }}</td>
                </tr>
                <tr>
        ...
        @if($permohonanNonLitigasi->file_ktp_kk)
            ...
            @else
                <p style="font-size: 11pt; color: #555;">[File PDF terlampir –
                    {{ basename($permohonanNonLitigasi->file_ktp_kk) }}]
                </p>
            @endif
        @endif
        ...
        @if($permohonanNonLitigasi->file_sktm)
            ...
            @else
                <p style="font-size: 11pt; color: #555;">[File PDF terlampir –
                    {{ basename($permohonanNonLitigasi->file_sktm) }}]
                </p>
            @endif
        @endif
        ...
        <div style="margin-top: 48px; display: flex; justify-content: flex-end;">
            <div style="text-align: center; min-width: 240px;">
                ...
                <div style="font-size: 11pt; margin-top: 4px;">{{ $permohonanNonLitigasi->created_at->format('d M Y') }}
                </div>
            </div>
        </div>
