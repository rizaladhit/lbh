            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4">
                    <p class="text-muted mb-4">
                        Anda akan memverifikasi permohonan litigasi dari <strong>{{ $permohonanNonNon-Litigasi->nama }}</strong> 
                        dengan nomor registrasi <strong>{{ $permohonanNonNon-Litigasi->no_registrasi }}</strong>.
                    </p>

                    <form method="POST" action="{{ route('permohonan-non-litigasi.storeVerify', $permohonanNonNon-Litigasi) }}" class="needs-validation" novalidate>
                        @csrf
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4" style="font-size: 0.95rem;">
                    @php $fields = [
                        ...
                        'Uraian Singkat' => $permohonanNonNon-Litigasi->uraian_singkat,
                    ]; @endphp
