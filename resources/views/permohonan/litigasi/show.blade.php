            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-3 p-md-4" style="font-size: 0.95rem;">
                    ...
                    <div class="d-flex flex-column flex-md-row border-bottom py-2">
                        ...
                        <div class="text-muted"><span class="d-md-none">: </span><span class="d-none d-md-inline">: </span>{{ $permohonanLitigasi->verification_notes }}</div>
                    </div>
                    @endif
                    ...
                    <div class="d-flex flex-column flex-md-row border-bottom py-2">
                        ...
                        <div class="text-muted"><span class="d-md-none">: </span><span class="d-none d-md-inline">: </span>{{ $permohonanLitigasi->assignedLawyer->name }}</div>
                    </div>
                    @endif
                    ...
                    <div class="d-flex flex-column flex-md-row border-bottom py-2">
                        ...
                        <div class="text-muted"><span class="d-md-none">: </span><span class="d-none d-md-inline">: </span>{{ $permohonanLitigasi->assignedParalegal->name }}</div>
                    </div>
                    @endif
                    ...
                    <div class="d-flex flex-column flex-md-row border-bottom py-2">
                        ...
                        <div class="text-muted"><span class="d-md-none">: </span><span class="d-none d-md-inline">: </span>{{ $permohonanLitigasi->activity_notes }}</div>
                    </div>
                    @endif
