            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4">
                    <p class="text-muted mb-4">
                        Anda akan memverifikasi permohonan litigasi dari <strong>{{ $permohonanLitigasi->nama }}</strong> 
                        dengan nomor registrasi <strong>{{ $permohonanLitigasi->no_registrasi }}</strong>.
                    </p>

                    <form method="POST" action="{{ route('permohonan-litigasi.storeVerify', $permohonanLitigasi) }}" class="needs-validation" novalidate>
                        @csrf
