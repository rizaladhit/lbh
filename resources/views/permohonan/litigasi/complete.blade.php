            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4">
                    <p class="text-muted mb-4">
                        Tandai penanganan permohonan litigasi dari <strong>{{ $permohonanLitigasi->nama }}</strong> 
                        (No. Registrasi: <strong>{{ $permohonanLitigasi->no_registrasi }}</strong>) 
                        sebagai selesai dan buat catatan kegiatan penanganan.
                    </p>

                    <form method="POST" action="{{ route('permohonan-litigasi.storeComplete', $permohonanLitigasi) }}" class="needs-validation" novalidate>
                        @csrf
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4" style="font-size: 0.95rem;">
                    ...
                    <div class="d-flex border-bottom py-2">
                        ...
                        <div class="text-muted">: {{ Str::limit($permohonanLitigasi->verification_notes, 100) }}</div>
                    </div>
                    @endif
                </div>
            </div>
