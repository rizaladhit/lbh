...
<head>
    ...
    <title>Cetak Checklist Berkas - {{ $negosiasiReport->nama_negosiator }}</title>
...
<body>
    ...
    <div class="print-actions">
        ...
        <a href="{{ route('negosiasi-reports.show', $negosiasiReport) }}" class="btn btn-secondary btn-sm fw-medium">
            Kembali
        </a>
    </div>
        ...
        <div class="pv-group pv-g2">
            ...
            <div class="pv-row">
                ...
                <span class="pv-val" style="display:flex;justify-content:space-between;">
                    <span>{{ $negosiasiReport->penerima_bantuan }}</span>
                    <strong>L/P : {{ $negosiasiReport->jk_penerima }}</strong>
                </span>
            </div>
            <div class="pv-row">
