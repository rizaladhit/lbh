        ...
        <div class="col-xl-10">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('negosiasi-reports.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8 d-flex align-items-center">
                                : <input type="text" name="nama_negosiator" class="form-control ms-2 border-secondary border-opacity-50" value="{{ old('nama_negosiator') }}" required>
                                    ...
                                    @foreach($berkas_list as $idx => $label)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist[{{ $idx }}][obh]" value="1" {{ old('checklist.'.$idx.'.obh') ? 'checked' : '' }}>
                                            </td>
                                            <td class="text-center">
                                                <input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist[{{ $idx }}][kanwil]" value="1" {{ old('checklist.'.$idx.'.kanwil') ? 'checked' : '' }}>
                                            </td>
                                            <td class="text-center">
                                                <input class="form-check-input border-secondary shadow-none fs-4" type="checkbox" name="checklist[{{ $idx }}][bphn]" value="1" {{ old('checklist.'.$idx.'.bphn') ? 'checked' : '' }}>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="d-flex justify-content-end align-items-center pt-3 border-top">
                            <a href="{{ route('negosiasi-reports.index') }}" class="btn btn-light border me-2 fw-medium">Batal</a>
