    ...
    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 class="mb-0 fw-bold text-body">Daftar Laporan BPHN</h6>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding-left:24px;">
                            <div style="font-size:.8rem;font-weight:700;font-family:monospace;" class="text-body">{{ Str::limit($report->kasus, 20) }}</div>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span style="font-size:.82rem;font-weight:500;" class="text-body">{{ $report->tgl_pelaksanaan->format('d M Y') }}</span>
                            </div>
                        </td>
                        <td>
                            <div style="font-size:.82rem;" class="text-body">{{ $report->nama_drafter }}</div>
                        </td>
