<x-app-layout>
    <x-slot name="header">Laporan Drafting Dokumen Hukum</x-slot>
    ...
    <div class="panel">
        <div class="panel-head">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 style="font-size:.85rem;font-weight:600;" class="mb-0 fw-bold text-body">Daftar Laporan Drafting Dokumen Hukum</h6>
                    <div style="font-size:.72rem;color:#94a3b8;">Total {{ $reports->total() }} laporan terdata</div>
                </div>
            </div>
            <a href="{{ route('drafting-reports.create') }}" class="btn-cta">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding-left:24px;">
                            <div style="font-size:.85rem;font-weight:600;" class="text-body">{{ Str::limit($report->kasus, 20) }}</div>
                        ...
                        <td>
                            <div style="font-size:.85rem;font-weight:600;" class="text-body">{{ $report->nama_drafter }}</div>
                        </td>
                        <td style="padding-right:24px;text-align:right;">
                            <div class="d-flex justify-content-end gap-1">
                                <a href="{{ route('drafting-reports.show', $report) }}" class="action-btn" style="color:#6366f1;" title="Detail Laporan">
                                    <i class="fa-solid fa-eye"></i>
                                </a>
                                <a href="{{ route('drafting-reports.edit', $report) }}" class="action-btn" style="color:#f59e0b;" title="Edit Laporan">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                @if(auth()->user()->role === 'admin')
                                <button onclick="confirmDelete('{{ route('drafting-reports.destroy', $report) }}')" class="action-btn" style="color:#ef4444;" title="Hapus Laporan">
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <h6 style="font-size:.85rem;font-weight:600;" class="fw-bold text-body mb-1">Belum Ada Laporan BPHN</h6>
                                <p class="text-muted mb-4" style="font-size:.85rem;">Mulai dengan membuat laporan Drafting Dokumen Hukum yang pertama.</p>
                                <a href="{{ route('drafting-reports.create') }}" class="btn-cta" style="margin:auto;width:fit-content;">
