            ...
            <div class="card shadow-md border-0 mb-4 p-4 p-md-5" id="printableArea">
                ...
                <div class="card-body p-0" style="font-size: 0.95rem;">
                    ...
                    <div class="d-flex mb-1">
                        ...
                        <div class="w-100">: {{ $draftingReport->penerima_bantuan }} <span class="float-end pe-5"><strong>L/P:</strong> {{ $draftingReport->jk_penerima }}</span></div>
                    </div>
                    <div class="d-flex mb-4">
                    ...
                    <table class="table table-bordered border-secondary align-middle mb-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center border-bottom-0"><span class="checklist-square">{!! $get_check($d, '5_1', 'obh') !!}</span></td>
                                <td class="text-center border-bottom-0"><span class="checklist-square">{!! $get_check($d, '5_1', 'kanwil') !!}</span></td>
                                <td class="text-center border-bottom-0"><span class="checklist-square">{!! $get_check($d, '5_1', 'bphn') !!}</span></td>
                            </tr>
                            <tr>
                                <td></td>
